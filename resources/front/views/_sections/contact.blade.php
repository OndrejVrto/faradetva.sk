					...
					<div class="contact_form_wrap">
						<form>
							...
							<div class="form-group">
								...
								<span class="input_icon"><i class="fa fa-envelope" aria-hidden="true"></i></span>
							</div>
							<div class="form-group">
								<input type="text" name="contact" id="u_phone" placeholder="Kontaktné číslo">
								<span class="input_icon"><i class="fa fa-phone" aria-hidden="true"></i></span>
							</div>
							<div class="form-group">
							...
							<button type="button" class="submit_btn read_btn" id="submit_btn">Pošli správu
