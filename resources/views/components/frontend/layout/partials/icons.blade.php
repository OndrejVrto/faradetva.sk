...
<link rel="icon" type="image/png" sizes="36x36" href="{{ asset('favicons/android-chrome-36x36.png', true) }}">
<link rel="icon" type="image/png" sizes="48x48" href="{{ asset('favicons/android-chrome-48x48.png', true) }}">
<link rel="icon" type="image/png" sizes="72x72" href="{{ asset('favicons/android-chrome-72x72.png', true) }}">
<link rel="icon" type="image/png" sizes="96x96" href="{{ asset('favicons/android-chrome-96x96.png', true) }}">
<link rel="icon" type="image/png" sizes="144x144" href="{{ asset('favicons/android-chrome-144x144.png', true) }}">
...
<link rel="icon" type="image/png" sizes="384x384" href="{{ asset('favicons/android-chrome-384x384.png', true) }}">
<link rel="icon" type="image/png" sizes="512x512" href="{{ asset('favicons/android-chrome-512x512.png', true) }}">

<link rel="apple-touch-icon" sizes="57x57" href="{{ asset('favicons/apple-touch-icon-57x57.png', true) }}">
<link rel="apple-touch-icon" sizes="60x60" href="{{ asset('favicons/apple-touch-icon-60x60.png', true) }}">
<link rel="apple-touch-icon" sizes="72x72" href="{{ asset('favicons/apple-touch-icon-72x72.png', true) }}">
<link rel="apple-touch-icon" sizes="76x76" href="{{ asset('favicons/apple-touch-icon-76x76.png', true) }}">
...
<link rel="mask-icon" href="{{ asset('favicons/safari-pinned-tab.svg', true) }}" color="#1b2e41">

<link rel="manifest" href="{{ asset('favicons/site.webmanifest', true) }}">

<meta name="application-name" content="Fara Detva">
<meta name="msapplication-TileColor" content="#575049">
