...
@section('content')
    <x-admin.table
        ...
        <x-slot:table_header>
            ...
            <x-admin.table.th class="text-center">Poradie (-100 až 100)</x-admin.table.th>
        ...
        <x-slot:table_body>
            @foreach($faqs as $faq)
                <tr>
                    ...
                    <x-admin.table.td class="text-wrap text-break">{{ Str::limit( Str::plainText($faq->answer), 70) }}</x-admin.table.td>
                    <x-admin.table.td class="text-center">{{ $faq->order }}</x-admin.table.td>
