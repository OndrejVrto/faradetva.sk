<x-web.layout.master :pageData="$pageData">
    ...
    <x-web.page.subsection title="Ako sa možno pripraviť na ľútosť nad hriechmi?">
        <x-web.page.text-segment animation="fromright">
            <p>
    ...
    <x-web.page.subsection title="Môže človek pristúpiť k sviatosti zmierenia aj keď sa nedopustil žiadnych smrteľných hriechov?">
        {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
        <x-web.page.text-segment animation="fromleft">
            <p>
    ...
    <x-web.page.subsection title="Môže kňaz prezradiť niečo z toho, čo sa dozvedel vo sviatosti zmierenia?">
        {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
        <x-web.page.text-segment animation="fromleft">
            <p>
    ...
    <x-web.page.subsection title="Aký pozitívny účinok prináša sviatosť zmierenia?">
        <x-web.page.text-segment animation="fromright">
            <p>
