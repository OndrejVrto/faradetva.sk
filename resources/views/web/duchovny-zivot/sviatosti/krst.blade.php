<x-web.layout.master :pageData="$pageData">
    ...
    <x-web.page.subsection title="Ako sa udeľuje krst?">
    ...
    <x-web.page.subsection title="Prečo Cirkev krstí malé deti?">
        {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4"/> --}}
        <x-web.page.text-segment animation="fromright">
            <p>
    ...
    <x-web.page.subsection title="Ako sa vysluhuje sviatosť krstu v našej farnosti?">
        {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
        <x-web.page.text-segment animation="fromleft">
            <p>
    ...
    <x-web.page.subsection title="Kto môže byť krstným rodičom?">
        {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4"/> --}}
        <x-web.page.text-segment animation="fromright">
            <p>
    ...
    <x-web.page.subsection title="Podmienky k tomu, aby mohol byť niekto krstným rodičom:">
        {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
        <x-web.page.text-segment animation="fromleft">
            <ul>
    ...
    <x-web.page.subsection title="Ako prebieha príprava ku krstu starších detí a dospelých?">
        {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4"/> --}}
        <x-web.page.text-segment animation="fromright">
            <p>
