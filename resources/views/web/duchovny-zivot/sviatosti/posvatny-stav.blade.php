<x-web.layout.master :pageData="$pageData">
    ...
    <x-web.page.subsection title="Aké miesto má sviatosť posvätného stavu v Božom pláne spásy?">
    ...
    <x-web.page.subsection title="Kto môže prijať sviatosť posvätného stavu?">
        <x-web.page.text-segment animation="fromright">
            <p>
    ...
    <x-web.page.subsection title="Aký účinok má biskupská vysviacka?">
        {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
        <x-web.page.text-segment animation="fromleft">
            <p>
