<x-web.layout.master :pageData="$pageData">
    ...
    <x-web.page.subsection title="Komu je určená sviatosť chorých?">
    ...
    <x-web.page.subsection title="Ako sa slávi sviatosť pomazania chorých?">
        <x-web.page.text-segment animation="fromright">
            <p>
    ...
    <x-web.page.subsection title="Čo je to viatikum?">
        {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4"/> --}}
        <x-web.page.text-segment animation="fromright">
            <p>
