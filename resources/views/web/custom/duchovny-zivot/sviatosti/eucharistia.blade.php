<x-web.layout.master :pageData="$pageData">
    ...
    <x-web.page.subsection title="Nakoľko je Eucharistia dôležitá pre Cirkev?">
    ...
    <x-web.page.subsection title="Kto vedie slávenie Eucharistie?">
        {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="5" /> --}}
        <x-web.page.text-segment animation="fromleft">
            <p>
    ...
    <x-web.page.subsection title="	Akým spôsobom sa Cirkev podieľa na Eucharistii?">
        {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
        <x-web.page.text-segment animation="fromleft">
            <p>
    ...
    <x-web.page.subsection title="Ako máme správne uctievať Pána Ježiša prítomného v chlebe a vo víne?">
        {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4"/> --}}
        <x-web.page.text-segment animation="fromright">
            <p>
    ...
    <x-web.page.subsection title="Ako sa mám pripraviť, aby som mohol pristúpiť k svätému prijímaniu?">
        <x-web.page.text-segment animation="fromright">
            <p>
    ...
    <x-web.page.subsection title="Ako ma mení sväté prijímanie?">
        {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
        <x-web.page.text-segment animation="fromleft">
            <p>
