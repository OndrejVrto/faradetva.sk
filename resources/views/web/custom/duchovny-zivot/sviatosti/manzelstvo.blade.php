<x-web.layout.master :pageData="$pageData">
    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) PART I -" class="static-page pad_b_50">
        ...
        <x-web.page.subsection title="Čo nevyhnutne patrí k&nbsp;sviatostnému manželstvu?">
            <x-web.page.text-segment animation="fromleft">
                ...
                <ul class="list-unstyled ms-4">
                    <li>a) slobodný súhlas,</li>
                    <li>b) dobrovoľné prijatie celoživotného výlučného zväzku,</li>
                    <li>c) otvorenosť na prijatie potomstva.</li>
                </ul>
                <p>
        ...
        <x-web.page.subsection title="Sú všetci ľudia povolaní do manželstva?">
            <x-web.page.text-segment animation="fromleft">

                <x-partials.picture titleSlug="sacr7-002" side="left" dimensionSource="medium" columns="5" />
        ...
        <x-web.page.subsection title="Ako treba postupovať pred uzavretím manželstva?">
            <x-web.page.text-segment animation="fromright">
                <p>
    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) PART II -" class="static-page pad_t_50 pad_b_50">
        ...
        <x-web.page.subsection title="Môžu sa manželia žijúci v&nbsp;trvalých nezhodách odlúčiť?">
            <x-web.page.text-segment animation="fromright">

                <x-partials.picture titleSlug="sacr7-006" side="left" dimensionSource="medium" columns="4" />
                ...
                <x-partials.picture titleSlug="sacr7-003" side="right" dimensionSource="medium" columns="4" />
    ...
    <x-web.sections.background-picture titleSlug="kronika-086 "/>

    <x-web.sections.notice typeNotice="marriage" id="rozpis" class="pad_t_50"/>
