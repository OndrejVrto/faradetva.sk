    ...
    <x-web.page.section name="PAGE: ({{$pageData['title']}}) PART I -" class="static-page pad_b_50">
        ...
        <x-web.page.subsection title="Ako reagovať na rušivé vplyvy?" animation="fromleft">
            <x-web.page.text-segment animation="fromleft">
                ...
                <p>
                    Elementárna slušnosť káže vypnúť si pred vstupom do kostola mobilný telefón. Často sa však stáva, že počas svätej omše niekomu telefón zazvoní, ba dokonca niekto v kostole aj telefonuje. Môže sa to prihodiť, s tým treba počítať, sme jednoducho ľudia, sme omylní. Aj pri zvonení cudzích mobilných telefónov však ide v prvom rade o našu osobnú koncentráciu na svätú omšu. No prijať hovor alebo posielať SMS správy v kostole je neslušné!
                </p>
            </x-web.page.text-segment>
        </x-web.page.subsection>
