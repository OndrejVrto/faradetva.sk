    ...
    <x-web.page.section name="PAGE: ({{$pageData['title']}}) PART I -" class="static-page pad_b_50">
        ...
        <x-web.page.subsection>
            ...
            <x-web.page.text-segment animation="fromleft">
                ...
                <x-partials.picture titleSlug="pob-005" side="left" animation="fromleft" dimensionSource="full" columns="3" />

                <x-partials.picture titleSlug="pob-004" side="right" animation="fromright" dimensionSource="medium" columns="3" />
                <p>
                ...
                <p>
                    Rozličné kultové prejavy súkromného alebo komunitného charakteru označujeme výrazom „ľudová zbožnosť“. Tieto prejavy ľudovej zbožnosti sa vyjadrujú prevažne nie prvkami posvätnej liturgie, ale zvláštnymi formami, ktoré vyplývajú z ducha určitého národa alebo určitej etnickej skupiny a jej kultúry. Ľudová zbožnosť je pokladaná za pravý poklad Božieho ľudu. Vyjadruje smäd po Bohu a má veľký zmysel pre hlboké atribúty Boha: jeho otcovstvo, prozreteľnosť, milujúcu a trvalú prítomnosť, trpezlivosť, zmysel pre kríž v každodennom živote, odpútanosť, otvorenosť voči druhým a nábožnosť.
                </p>
                <p>
        ...
        <x-web.page.subsection title="Liturgický rok a ľudová zbožnosť">
            {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
            <x-web.page.text-segment>

                <x-partials.picture titleSlug="pob-006" side="left" animation="fromleft" dimensionSource="medium" columns="3" />
                ...
                <x-partials.picture titleSlug="pob-001" side="right" animation="fromright" dimensionSource="small" columns="2" />
        ...
        <x-partials.photo-gallery titleSlug="kalvaria-v-detve" dimensionSource="medium"/>
    ...
    <x-web.page.section name="PAGE: ({{$pageData['title']}}) PART II -" class="static-page pad_b_50">
        ...
        <x-web.page.subsection class="pt-5">
            <x-web.page.text-segment>
                ...
                <x-partials.picture titleSlug="pob-008" side="left" animation="fromleft" dimensionSource="medium" columns="6" />
                ...
                <x-partials.picture titleSlug="pob-017" side="right" animation="fromright" dimensionSource="full" columns="3" />
                ...
                <p>
                    Jedným z najrozšírenejších a najobľúbenejších prejavov cirkevnej zbožnosti sa stala úcta k Najsvätejšiemu Srdcu Ježišovmu. Foriem úcty k Spasiteľovmu Srdcu je viacero: osobné zasvätenie, zasvätenie rodiny, Litánie k Najsvätejšiemu Srdcu Ježišovmu, Pobožnosť deviatich prvých piatkov mesiaca, ktorá má svoj pôvod vo veľkom prisľúbení, ktoré dal Pán Ježiš sv. Margite Márii Alacoque. Osobitné postavenie má aj uctievanie Pánovej krvi, vyliatej za našu spásu a uvedomovanie si jej nesmiernej hodnoty (napr. Litánie Kristovej krvi).
                </p>
                <p>
                    V povedomí Ježišovej modlitby „aby všetci boli jedno, ako ty, Otče, vo mne a ja v tebe, aby aj oni boli v nás jedno, aby svet uveril, že si ma ty poslal“ (Jn 17,21), sa zvlášť počas Týždňa modlitieb za jednotu kresťanov, od 17. do 25. januára, odporúča spoločná modlitba za dosiahnutie milosti jednoty. Ekumenické stretnutia sa katolíkov s inými kresťanmi patriacimi do iných cirkví a cirkevných spoločenstiev majú slúžiť k predloženiu spoločných potrieb a starostí Bohu, i na vzdávanie vďaky Bohu a spoločné vyprosenie jeho pomoci.
                </p>
            </x-web.page.text-segment>
        </x-web.page.subsection>

        <x-partials.photo-gallery titleSlug="sviatok-bozieho-tela" dimensionSource="medium" class="pb-5"/>

        <x-web.page.subsection title="Uctievanie svätej Matky Pána Ježiša" animation="fromleft">
            {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
            <x-web.page.text-segment animation="fromleft">

                <x-partials.picture titleSlug="pob-020" side="left" animation="fromleft" dimensionSource="medium" columns="2" />
        ...
        <x-web.page.subsection title="Uctievanie svätých a blahoslavených">
            {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
            <x-web.page.text-segment>

                <x-partials.picture titleSlug="pob-019" side="right" animation="fromright" dimensionSource="medium" columns="2" />
                ...
                <x-partials.picture titleSlug="pob-018" side="left" animation="fromleft" dimensionSource="medium" columns="3" />
                ...
                <p>
                    Uctievanie svätých a blahoslavených sa prejavuje najmä v liturgických spomienkach, sviatkoch a slávnostiach, ale aj v rôznych pobožnostiach: v litániách k svätým, v úcte relikvií svätých, v uctievaní obrazov, sôch, reliéfov alebo iných stvárnení svätých či v procesiách.
                </p>
            </x-web.page.text-segment>
        </x-web.page.subsection>

        <x-partials.photo-gallery titleSlug="relikvie-sv-terezie-z-lisieux" dimensionSource="medium"/>
        ...
        <x-web.page.information-sources title="Použitá literatúra:">
            <li>
                ...
                <em class="me-1">Detva. Monografia mesta.</em>
                Detva: Mesto Detva, 2018. ISBN 978-80-9730011-2-5.
            </li>
            <li>
                <em class="me-1">Direktórium o ľudovej zbožnosti a liturgii.</em>
                Trnava: Spolok sv. Vojtecha, 2005. ISBN 80-7162-547-7.
            </li>
