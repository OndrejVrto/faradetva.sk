    ...
    <x-web.page.section name="PAGE: ({{$pageData['title']}}) PART I -" class="static-page pad_b_30">
        ...
        <x-web.page.subsection>
            <x-web.page.text-segment animation="fromleft">
                ...
                <x-partials.picture titleSlug="put-011" side="left" dimensionSource="medium" columns="4" />
                ...
                <x-partials.picture titleSlug="put-014" side="right" dimensionSource="full" columns="4" />
    ...
    <x-web.page.section name="PAGE: ({{$pageData['title']}}) PART II -" class="static-page pad_b_50">
        ...
        <x-web.page.subsection class="pt-5">
            ...
            <x-web.page.text-segment>
                ...
                <x-partials.picture titleSlug="put-002" side="left" dimensionSource="medium" columns="4" />
                ...
                <x-partials.picture titleSlug="put-015" side="right" dimensionSource="full" columns="3" />
        ...
        <x-partials.photo-gallery titleSlug="putovanie-farnikov-z-detvy" dimensionSource="medium"/>

        <x-web.page.information-sources title="Použitá literatúra:">
            <li>
                PIATROVÁ, Alena. ed. <em class="me-1">Pútnické miesta Slovenska. Sprievodca.</em>
                Trnava: Filozofická fakulta Trnavskej univerzity, 2010. ISBN 808082-132-6.
            </li>
            <li>
