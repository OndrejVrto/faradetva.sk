<x-web.layout.master :pageData="$pageData">
    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) PART II -" class="static-page pad_t_50 pad_b_50">
        ...
        <x-web.page.information-sources title="Použitá literatúra:">
            ...
            <li>
                KOPEČEK, Pavel.
                <em class="me-1">Fundamentální liturgika. Křesťanské slavení: teologie, historie a&nbsp;pastorace.</em>
                Olomouc: Univerzita Palackého v&nbsp;Olomouci, 2020. ISBN 978-80-244-5906-6.
            </li>

            <li>
                <em class="me-1">Rímsky pontifikál.</em>
                Trnava: Spolok sv. Vojtecha, 1981.
            </li>
