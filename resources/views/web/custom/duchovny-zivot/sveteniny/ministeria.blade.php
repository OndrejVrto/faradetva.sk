<x-web.layout.master :pageData="$pageData">
    ...
    <x-web.page.section name="PAGE: ({{$pageData['title']}}) -" class="static-page pad_b_50">
        ...
        <x-web.page.subsection title="Akolytát" animation="fromleft">
            {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
            <x-web.page.text-segment animation="fromleft">
                <p>
        ...
        <x-web.page.subsection title="Katechista">
            {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
            <x-web.page.text-segment>
                <p>
        ...
        <x-web.page.information-sources title="Použitá literatúra:">
            ...
            <li>Rímsky pontifikál. Trnava: Spolok sv. Vojtecha, 1981.</li>
            <li>Apoštolský list motu proprio Antiquum ministerium [online]. [cit. 02.02.2022]. Dostupné na internete: https://www.kbs.sk/obsah/sekcia/h/dokumenty-a-vyhlasenia/p/dokumenty-papezov/c/apostolsky-list-antiquum-ministerium</li>
            <li>Apoštolský list motu proprio Spiritus Domini [online]. [cit. 01.02.2022]. Dostupné na internete: https://www.kbs.sk/obsah/sekcia/h/dokumenty-a-vyhlasenia/p/dokumenty-papezov/c/motu-proprio-spiritus-domini</li>
            <li>Pápež František ustanovil prístup k lektorátu a akolytátu i pre ženy [online]. [cit. 01.02.2022]. Dostupné na internete: https://www.vaticannews.va/sk/papez/news/2021-01/frantisek-ustanovil-pristup-k-lektoratu-a-akolytatu-i-pre-zeny.html</li>
            <li>Pápež František zriadil laické ministérium katechétu listom Antiquum ministerium [online]. [cit. 02.02.2022]. Dostupné na internete: https://www.vaticannews.va/sk/papez/news/2021-05/papez-frantisek-zriadil-laicke-ministerium-katechetu.html</li>
