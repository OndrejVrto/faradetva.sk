    ...
    <x-web.page.section name="PAGE: ({{$pageData['title']}}) -" class="static-page pad_b_50">
        ...
        <x-web.page.subsection >
            ...
            <x-web.page.text-segment animation="fromright">
                ...
                <x-partials.picture titleSlug="pohr-001" side="right" dimensionSource="full" columns="3" />
                ...
                <x-partials.picture titleSlug="pohr-004" side="left" dimensionSource="full" columns="4" />
        ...
        <x-web.page.subsection title="Pochovávanie a uchovávanie popola v prípade kremácie">
            ...
            <x-web.page.text-segment animation="fromright">
                ...
                <x-partials.picture titleSlug="pohr-005" side="left" dimensionSource="full" columns="3" />
                ...
                <x-partials.picture titleSlug="pohr-006" side="right" dimensionSource="full" columns="3" />
        ...
        <x-web.page.subsection>
            ...
            <x-web.page.text-segment animation="fromleft">
                ...
                <x-partials.picture titleSlug="pohr-007" side="right" dimensionSource="full" columns="4" />
        ...
        <x-web.page.subsection>
            ...
            <x-web.page.text-segment animation="fromleft">
                ...
                <x-partials.picture titleSlug="pohr-010" side="left" dimensionSource="full" columns="3" />
