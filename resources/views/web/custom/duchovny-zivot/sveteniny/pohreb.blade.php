<x-web.layout.master :pageData="$pageData">
    ...
    <x-web.page.subsection >
        ...
        <x-web.page.text-segment animation="fromright">
            ...
            <x-partials.picture titleSlug="pohr-002" side="left" animation="fromleft" dimensionSource="full" columns="3" />
            ...
            <x-partials.picture titleSlug="pohr-001" side="right" animation="fromright" dimensionSource="full" columns="3" />
            ...
            <x-partials.picture titleSlug="pohr-004" side="left" animation="fromleft" dimensionSource="full" columns="4" />
    ...
    <x-web.page.subsection title="Pochovávanie a uchovávanie popola v prípade kremácie">
        ...
        <x-web.page.text-segment animation="fromright">
            ...
            <x-partials.picture titleSlug="pohr-005" side="left" animation="fromleft" dimensionSource="full" columns="3" />
            ...
            <x-partials.picture titleSlug="pohr-006" side="right" animation="fromright" dimensionSource="full" columns="3" />
    ...
    <x-web.page.subsection>
        ...
        <x-web.page.text-segment animation="fromleft">
            ...
            <x-partials.picture titleSlug="pohr-007" side="right" animation="fromright" dimensionSource="full" columns="4" />
            ...
            <x-partials.picture titleSlug="pohr-008" side="left" animation="fromleft" dimensionSource="full" columns="3" />
    ...
    <x-web.page.subsection>
        ...
        <x-web.page.text-segment animation="fromleft">
            ...
            <x-partials.picture titleSlug="pohr-009" side="right" animation="fromright" dimensionSource="full" columns="3" />
            ...
            <x-partials.picture titleSlug="pohr-010" side="left" animation="fromleft" dimensionSource="full" columns="3" />
