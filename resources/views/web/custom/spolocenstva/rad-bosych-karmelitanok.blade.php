<x-web.layout.master :pageData="$pageData">
    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) -" class="static-page pad_b_50">
        ...
        <x-web.page.subsection >
            <x-web.page.text-segment animation="fromright">
                ...
                <x-partials.picture titleSlug="rbk-054" side="left" dimensionSource="medium" columns="1" />

                <p>
                    Začiatky karmelitánskeho rádu siahajú do Svätej zeme, až k&nbsp;prorokovi Eliášovi, ktorý v&nbsp;samote hory Karmel hľadal Boha. Stal sa tak vzorom pustovníckeho života. Jeho slová: <em>„Žije Pán, v&nbsp;ktorého službe stojím“</em> (1Kr 17,1) sú vzorom života v&nbsp;Božej prítomnosti, ktorý sa stal základným prvkom karmelitánskej spirituality.
                </p>
                ...
                <x-partials.picture titleSlug="rbk-018" side="right" dimensionSource="medium" columns="4" />
    ...
    <x-web.sections.background-picture titleSlug="rbk-026"/>
    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) PART II -" class="static-page pad_t_50 pad_b_50">
        ...
        <x-web.page.subsection title="Modlitba - srdce karmelitánskeho života">
            <x-web.page.text-segment animation="fromleft">
                ...
                <x-partials.picture titleSlug="rbk-001" side="right" dimensionSource="medium" columns="3" />

                <p>
                    Apoštolát, ktorému sa majú venovať bosé karmelitánky, je výlučne apoštolát modlitby a&nbsp;obety. <em>„Povolanie bosých karmelitánok je darom Ducha Svätého, skrze ktorého sú povolané k&nbsp;„tajomnému spojeniu s&nbsp;Bohom“, v&nbsp;priateľstve s&nbsp;Kristom a&nbsp;v&nbsp;dôvernosti s&nbsp;Preblahoslavenou Pannou Máriu, v&nbsp;živote, v&nbsp;ktorom sa modlitba a&nbsp;obeta spájajú s&nbsp;veľkou láskou k&nbsp;Cirkvi.</em>
                </p>

                <x-partials.picture titleSlug="rbk-047" side="left" dimensionSource="medium" columns="2" />

                <p>
                    <em>Preto silou svojho povolania sú karmelitánky pozvané ku kontemplácii v&nbsp;modlitbe aj v&nbsp;živote. Tento záväzok neustálej modlitby oživuje viera, nádej a&nbsp;nadovšetko Božia láska, takže s&nbsp;čistým srdcom môžu dosiahnuť plnosť života v&nbsp;Kristovi a&nbsp;pripraviť sa na prijatie čoraz hojnejších darov Ducha. Tereziánska charizma vyžaduje, aby sa modlitba, zasvätenie a&nbsp;celý život bosých karmelitánok orientovali na spásu duší.“</em> (Konštitúcie bosých karmelitánok)
                </p>
        ...
        <x-web.page.subsection>
            <x-web.page.text-segment animation="fromright">
                ...
                <x-partials.picture titleSlug="rbk-004" side="left" dimensionSource="medium" columns="3" />
    ...
    <x-web.sections.background-picture titleSlug="klk-020"/>

    <x-web.page.section name="PAGE: ({{ $pageData->title }}) PART II -" class="static-page pad_t_50 pad_b_50">

        <x-web.page.subsection title="Práca">
            <x-web.page.text-segment animation="fromright">

                <x-partials.picture titleSlug="rbk-003" side="right" dimensionSource="medium" columns="5" />
        ...
        <x-web.page.subsection title="Bosé karmelitánky vo svete a&nbsp;na Slovensku">
            <x-web.page.text-segment animation="fromright">

                <x-partials.picture titleSlug="rbk-007" side="left" dimensionSource="medium" columns="5" />
