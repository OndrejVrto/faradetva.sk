    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) -" class="static-page pad_b_50">
        ...
        <x-web.page.subsection >
            <x-web.page.text-segment animation="fromright">
                ...
                <x-partials.picture titleSlug="zf-000" side="left" dimensionSource="medium" columns="1" />

                <p>
                    Združenie apoštolov Božieho milosrdenstva <em>Faustínum</em> vychádza z&nbsp;charizmy sv.&nbsp;Faustíny, jej duchovnosti a&nbsp;apoštolskej činnosti. Spája kňazov, zasvätené osoby a&nbsp;laikov, ktorí chcú slúžiť posolstvu Božieho milosrdenstva.
                </p>
                ...
                <ol>
                    <li class="mb-2"><strong>Snažiť sa o&nbsp;kresťanskú dokonalosť</strong>, čiže o&nbsp;dokonalú lásku cestou rozvíjania postoja dôvery k&nbsp;Bohu a&nbsp;milosrdenstva voči blížnym.</li>
                    <li class="mb-2"><strong>Objavovať a&nbsp;ohlasovať tajomstvo Božieho milosrdenstva</strong>, ktoré sa najviac zjavilo v&nbsp;ukrižovanom a&nbsp;vzkriesenom Kristovi.</li>
                    <li class="mb-2"><strong>Vyprosovať Božie milosrdenstvo pre celý svet</strong>, najmä pre hriešnikov, kňazov a&nbsp;rehoľníkov.</li>
                </ol>

                <x-partials.picture titleSlug="zf-009" side="left" dimensionSource="medium" columns="12" />
