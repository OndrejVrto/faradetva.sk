<x-web.layout.master :pageData="$pageData">
    ...
    <x-web.page.subsection >
        <x-web.page.text-segment animation="fromright">
            ...
            <x-partials.picture titleSlug="mave-010" side="left" dimensionSource="medium" columns="2" />
            ...
            <x-partials.picture titleSlug="mave-006" side="right" dimensionSource="medium" columns="3" />

            <h4 class="pt-2 wow fromright" data-wow-delay="0.4s">
                Štruktúra večeradla
            </h4>
    ...
    <x-web.page.information-sources title="Použitá literatúra:">
        <li><em>Kňazom, najmilším synom Panny Márie.</em> Bratislava: Mariánske kňazské hnutie, 2000. ISBN 80-900417-0-1.</li>
