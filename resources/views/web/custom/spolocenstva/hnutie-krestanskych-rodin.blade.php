<x-web.layout.master :pageData="$pageData">
    ...
    <x-web.page.subsection >
        <x-web.page.text-segment animation="fromright">
            ...
            <x-partials.picture titleSlug="hkr-013" side="left" dimensionSource="full" columns="3" />
            <x-partials.picture titleSlug="hkr-041" side="right" dimensionSource="full" columns="3" />
            ...
            <x-partials.picture titleSlug="hkr-047" side="left" dimensionSource="full" columns="4" />
