    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) -" class="static-page pad_b_50">
        ...
        <x-web.page.subsection >
            <x-web.page.text-segment animation="fromright">
                ...
                <x-partials.picture titleSlug="sv-frantisek-ikona" side="right" dimensionSource="medium" columns="2" />
                ...
                <x-partials.picture titleSlug="ofs-009" side="left" dimensionSource="medium" columns="3" />
    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) PART II -" class="static-page pad_t_50 pad_b_50">
        ...
        <x-web.page.subsection>
            <x-web.page.text-segment animation="fromright">
                ...
                <x-partials.picture titleSlug="ofs-007" side="right" dimensionSource="medium" columns="4" />
