<x-web.layout.master :pageData="$pageData">
    ...
    <x-web.page.subsection >
        <x-web.page.text-segment animation="fromright">
            ...
            <x-partials.picture titleSlug="kcho-001" side="left" dimensionSource="full" columns="1" />
            {{-- <x-partials.picture titleSlug="kcho-004" side="right" dimensionSource="full" columns="4" /> --}}
            <x-partials.picture titleSlug="kcho-018" side="right" dimensionSource="full" columns="3" />
            ...
            <p>
                Pre vnútornú potrebu členov hnutia vychádza časopis <em>Charizma</em>. Každoročnou významnou aktivitou hnutia je celoslovenská konferencia Charizmatickej obnovy.
            </p>

            <x-partials.picture titleSlug="kcho-009" side="left" dimensionSource="full" columns="4" />
    ...
    <x-web.page.information-sources title="Použité pramane:">
        <li>
