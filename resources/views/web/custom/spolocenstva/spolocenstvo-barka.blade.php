    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) -" row="true" class="static-page pad_b_50">
        ...
        <x-web.page.subsection >
            <x-web.page.text-segment animation="fromright">
                ...
                <p>
                    „Pán zastavil sa na brehu, hľadal ľudí ochotných ísť za ním a&nbsp;loviť srdcia slov Božích pravdou.“ Toto sú prvé verše obľúbenej piesne svätého Jána Pavla II., v&nbsp;ktorých sa spieva o&nbsp;ochote mladých ľudí ísť za Pánom, ísť do zasväteného života. Spoločenstvo Bárka (loďka - po poľsky bárka) vzniklo v&nbsp;našej farnosti v&nbsp;roku 2000 na podnet vtedajšieho diecézneho otca biskupa Rudolfa Baláža, ktorý videl potrebu duchovne, ale i&nbsp;materiálne pomáhať banskobystrickým bohoslovcom v&nbsp;kňazskom seminári v&nbsp;Badíne.
                </p>

                <p>
                    Niekoľko veriacich detvianskej farnosti bolo ochotných pomáhať modlitbami a&nbsp;finančne konkrétnym bohoslovcom pri ich štúdiu a&nbsp;príprave na kňazské povolanie. Na začiatku vytváralo toto spoločenstvo desať ľudí, postupne pribúdali ďalší. Momentálne je v&nbsp;spoločenstve 15 stálych členov a&nbsp;8&nbsp;sú príležitostní podporovatelia. (r. 2022). Do pomoci sú zapojené aj ďalšie spoločenstvá, Modlitby matiek a&nbsp;Františkánsky svetský rád.
                </p>
