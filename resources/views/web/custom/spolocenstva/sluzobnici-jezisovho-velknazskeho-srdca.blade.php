    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) -" class="static-page pad_b_50">
        ...
        <x-web.page.subsection >
            <x-web.page.text-segment animation="fromright">
                ...
                <x-partials.picture titleSlug="sjvs-008" side="left" dimensionSource="medium" columns="1" />
                <x-partials.picture titleSlug="sjvs-001" side="right" dimensionSource="medium" columns="3" />
                ...
                <x-partials.picture titleSlug="sjvs-007" side="left" dimensionSource="medium" columns="3" />

                <p>
                    Ešte počas svojho života vyslovila proroctvo jednak o&nbsp;spoločenstve, ktoré vznikne po jej smrti a&nbsp;tiež o&nbsp;kňazovi, ktorý bude jeho duchovným otcom.
                    Týmto kňazom sa stal Tomáš Špidlík (1919 - 2010), z&nbsp;ktorého odkazu Služobníci čerpajú a&nbsp;pod ktorého záštitou sa opierajú o&nbsp;tri piliere duchovného života: Božské Srdce, ignaciánska spiritualita a&nbsp;Ježišovo Veľkňazstvo - prinášanie vlastného života ako obetu Bohu milú.
                </p>
                ...
                <x-partials.picture titleSlug="sjvs-003" side="right" dimensionSource="medium" columns="3" />
