<x-web.layout.master :pageData="$pageData">
    ...
    {{-- Služobníci Ježišovho Veľkňažského Srdca  --}}
    ...
    <x-web.page.section name="PAGE: ({{$pageData['title']}}) -" class="static-page pad_b_50">
        ...
        <x-web.page.subsection>
                ...
                <p>
                    Služobníci si prajú zdieľať s Ježišovým Veľkňazským Srdcom všetko, čo Ježiš sám prežíva, skrze úctu k jeho Božskému Srdcu. Denne kladú na obetný oltár jeho najnaliehavejšiu starosť dnešnej doby - kňazské srdcia. Spiritualita sv. Ignáca učí Služobníkov zvlášť diskrétnej láske: milovať Boha, druhých ľudí a slúžiť im s vnútornou zrelosťou tak, ako si praje sám Pán. Služobníci žijú vo svete vnútorne zasvätení Ježišovmu Vekňazskému Srdcu: čerpajú tak z krstného zasvätenia a z povolania k všeobecnému kňazstvu Cirkvi. Najhlbšou modlitbou Služobníkov je odovzdanie všetkého, čo prichádza, Božiemu Srdcu ako obetu za kňazov s tým, že o všetko ostatné, na čom im záleží, sa bude starať Pán.
                </p>
                <p>
                    Pre Služobníkov je podstatné žiť vnútorné zasvätenie v mieste a okolnostiach, ktoré im zveril Pán, každý podľa vlastného životného stavu. Majú možnosť tiež pravidelného stretávania sa na mnohých miestach Českej a Slovenskej republiky. Každý mesiac dostávajú poštou alebo e-mailom aktuálne informácie a slovo na rozjímanie. Dvakrát do roka sa môžu zúčastniť duchovnej obnovy na Velehrade. Konajú sa tiež, pravidelne v lete, púte do Medžugoria, rovnako ako na Velehrad k hrobu kardinála Tomáša Špidlíka alebo na Bílu Vodu k hrobu Matky Stanislavy.
                </p>
            </x-web.page.text-segment>
                <x-web.page.text-segment animation="fromright">
                <p>
                    Služobníci Ježišovho Veľkňazského Srdca sa v našej farnosti pravidelne stretávajú na spoločných modlitbách raz do mesiaca, vždy v stredu po prvom piatku, na eucharistickej adorácii od 19.30 do 20.30 hod. v kláštornom kostole bosých karmelitánok. Raz v roku sa spoločenstvo v Detve, ktoré aktuálne tvorí 15 členov (r. 2022), stretáva aj s koordinátorkou hnutia Kateřinou Klosovou. Starostlivosť o duchovné povolania je vecou všetkých veriacich, preto je každý pozvaný aj k spoločnej modlitbe za kňazov.
                </p>
            </x-web.page.text-segment>
        </x-web.page.subsection>
