    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) -" class="static-page pad_b_50">
        ...
        <x-web.page.subsection >
            <x-web.page.text-segment animation="fromright">
                ...
                <x-partials.picture titleSlug="logo-zdruzenia-salezianskych-spolupracovnikov" side="left" dimensionSource="medium" columns="1" />
                <x-partials.picture titleSlug="asc-036" side="right" dimensionSource="medium" columns="3" />
        ...
        <x-web.page.information-sources title="Použitý prameň:">
            ...
            <x-web.page.source-link
                date="24.01.2022"
                notice="<br> Bratislava: [s.n.], 2008."
                name="MÁJEKOVÁ, Ľubica."
                href="https://www.ascslovakia.sk/files/55cae762683b71c5e7e3c6ba1ba64226.pdf">
                    Stručné dejiny združenia saleziánov spolupracovníkov na Slovensku
            </x-web.page.source-link>
