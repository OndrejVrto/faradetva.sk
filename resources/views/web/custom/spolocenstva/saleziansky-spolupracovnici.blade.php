<x-web.layout.master :pageData="$pageData">
    ...
    <x-web.page.subsection>
        ...
        <x-web.page.text-segment animation="fromright">
            ...
            <p>
                V Banskobystrickej diecéze sú len tri strediská saleziánskych spolupracovníkov, a to v Čajkove, v Detve a vo Zvolene. Stredisko Detva má v súčasnosti 21 spolupracovníkov a vedie ho koordinátor Milan Václavík (r. 2022). Saleziánski spolupracovníci sa zapájajú do apoštolátu saleziánskej rodiny podľa svojich darov a možností. Niektorí viac v skrytosti (modlitbou či obetou utrpenia), iní napríklad verejne pôsobia v rozličných oblastiach - kultúrnych, spoločenských, ekonomických či politických. A to všetko saleziánskym spôsobom, ktorý je charakteristický radosťou, láskavosťou, rodinným duchom a láskou k mladým.
            </p>
        </x-web.page.text-segment>
    </x-web.page.subsection>

    <x-web.page.information-sources title="Použitá literatúra:">
        <li>MÁJEKOVÁ, Ľubica. Stručné dejiny združenia saleziánov spolupracovníkov na Slovensku [online]. Bratislava: [s.n.], 2008. [cit. 24.01.2022]. Dostupné na internete: https://www.ascslovakia.sk/files/55cae762683b71c5e7e3c6ba1ba64226.pdf</li>
