    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) -" class="static-page pad_b_50">
        ...
        <x-web.page.subsection>
            <x-web.page.text-segment animation="fromright">
                ...
                <x-partials.picture titleSlug="ktk-002" side="left" dimensionSource="medium" columns="4"/>
                ...
                <p>
                    Počas vyslovenia slov premenenia sa udial zázrak, ktorý popisuje kamenná tabuľa umiestnená na tomto mieste: <cite>„Zrazu sa hostia viditeľne premenila na skutočné mäso pokropené červenou krvou, okrem časti, za ktorú ju držal kňaz v&nbsp;rukách: nemohlo sa to udiať bez tajomstva, ale stalo sa tak preto, aby aj ostatní mohli vidieť, že je to naozaj hostia, ktorú drží v&nbsp;rukách celebrujúci kňaz nad kalichom.“</cite>
                </p>

                <x-partials.picture titleSlug="ktk-006" side="right" dimensionSource="medium" columns="3"/>
                ...
                <p>
                    Po dôkladnom preskúmaní pápež Urban IV. povolil jeho uctievanie a&nbsp;rozhodol o&nbsp;rozšírení sviatku Božieho tela, ktorý bol predtým lokálnym sviatkom diecézy Liegi, na celú Katolícku cirkev: <cite>„Aby táto vznešená a&nbsp;úctyhodná sviatosť bola pre všetkých pamiatkou mimoriadnej lásky Boha k&nbsp;nám.“</cite>
                </p>
                ...
                <x-partials.picture titleSlug="ktk-019" side="left" dimensionSource="medium" columns="3"/>
                ...
                <p>
                    Sviatok <em>Božího ťela</em> je cirkevne prikázaným sviatkom s&nbsp;pohyblivým dátumom. Slávi sa vo štvrtok po slávnosti Najsvätejšej Trojice (prvá nedeľa po skončení veľkonočného obdobia). Súčasťou bohoslužieb býva v&nbsp;Detve od nepamäti procesia sprevádzaná dychovou hudbou. Na štyroch miestach v&nbsp;uliciach mesta okolo kostola urobili miestne ženy zelené oltáriky - <em>koľibki</em>, pri ktorých sa udeľovalo eucharistické požehnanie.
                </p>

                <p>
                    <cite>Prvá bola na dolnom konci pri feštrovi, druhá pred Lašouskím, treťa pri Floriánkovi a&nbsp;štvrtá pred Vagačovci.</cite> (Svedectvo ženy narodenej v&nbsp;roku 1929). Kňaz s&nbsp;hostiou kráčal pod baldachýnom, ktorý niesli štyria chlapi v&nbsp;krojoch. Mládenci niesli vyzdobené zástavy a&nbsp;z&nbsp;nich visiace stuhy niesli dievky oblečené v&nbsp;bielych krojoch. Malé dievčatá posýpali cestu pred kňazom kvetnými lupeňmi, tieto zvykli byť od polovice 20. storočia oblečené v&nbsp;šatách z&nbsp;prvého svätého prijímania.
                </p>
