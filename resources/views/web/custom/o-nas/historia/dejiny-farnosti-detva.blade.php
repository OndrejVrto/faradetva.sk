<x-web.layout.master :pageData="$pageData">
    ...
    <x-web.page.subsection title="Vznik Detvy">
        ...
        {{-- <x-web.page.subsection.img columns="4" animation="fromleft" alt="" url="{{ asset('images/only-for-debug/sv-francisco/Josep_Benlliure_Gil43.jpg', true)  }}" /> --}}
    </x-web.page.subsection>
    ...
    <x-web.page.subsection title="Vznik farnosti">
        <x-web.page.text-segment animation="fromleft">
            ...
            {{-- <img class="img-fluid col-md-3 col-lg-2 mb-3 me-sm-4 float-sm-start rounded-3" src="{{ asset('images/only-for-debug/sv-francisco/11008.jpg', true) }}" alt=""> --}}
            <p>
