<x-web.layout.master :pageData="$pageData">
    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) PART I -" class="static-page pad_b_50">
        ...
        <x-web.page.subsection>
            ...
            <x-web.page.text-segment animation="fromright">
                ...
                <x-partials.picture titleSlug="dejf-003" side="right" columns="3" />
        ...
        <x-web.page.subsection title="Vznik Detvy">
            ...
            <x-web.page.text-segment animation="fromright">
                ...
                <p>
                    Krátko po založení Detvy v roku 1636, sa objavili pokusy zapojiť ju aj do cirkevnej správy. Detva vznikla v zložitom období reformácie a rekatolizácie, čo sa prejavilo aj na jej cirkevnom vývoji. V najstaršom období patrila pod správu Ostrihomskej arcidiecézy, zvolenského archidiakonátu a očovskej farnosti, ktorá bola v tom čase v rukách evanjelikov. Očovskí farári sa však pre rozľahlosť vlastnej farnosti nemohli dostatočne starať o duchovné potreby Detvanov, a preto Detva dostala samostatnú duchovnú správu.
                </p>

                <x-partials.picture titleSlug="dejf-076" side="right" columns="2" />

                <p>
                    Povolaním členov Spoločnosti Ježišovej (jezuitov) z Banskej Bystrice v prvej polovici 17. storočia sa rod Csákyovcov snažil o vytvorenie katolíckej oblasti na Podpoľaní, ktorá mala byť akousi protiváhou voči susedným evanjelickým oblastiam. Stála jezuitská misia, ktorú riadil Michal Luczicz, spravovala novozaloženú farnosť v dedine. V roku 1638 František Péchy daroval v Detve kúriu s pozemkami pre potreby fary. V darovanej budove bolo zriadené sídlo farnosti a až do postavenia kostola v nej bola aj provizórna kaplnka. Pôvodná drevená budova bola prestavaná na budovu z trvalých stavebných materiálov až v roku 1763.
                </p>
            </x-web.page.text-segment>
        </x-web.page.subsection>
    ...
    <x-web.sections.background-picture titleSlug="dej-001"/>

    <x-web.page.section name="PAGE: ({{ $pageData->title }}) PART II -" class="static-page pad_t_50 pad_b_50">

        <x-web.page.subsection title="Vznik farnosti">
            <x-web.page.text-segment animation="fromright">

                <x-partials.picture titleSlug="muzeum-041" side="left" columns="5" />
        ...
        <x-partials.picture titleSlug="dej-006" side="right" columns="12"/>

        <x-web.page.subsection title="Charakteristika">
            <x-web.page.text-segment animation="fromright">

                <x-partials.picture titleSlug="muzeum-032" side="right" columns="3" />
                ...
                <x-partials.picture titleSlug="dejf-043" side="left" columns="2" />
    ...
    <x-web.sections.background-picture titleSlug="dej-012"/>

    <x-web.page.section name="PAGE: ({{ $pageData->title }}) PART II -" class="static-page pad_t_50 pad_b_50">

        <x-web.page.subsection title="Neskorší rozvoj">
            <x-web.page.text-segment animation="fromright">
    ...
    <x-web.sections.background-picture titleSlug="dej-021"/>

    <x-web.page.section name="PAGE: ({{ $pageData->title }}) PART II -" class="static-page pad_t_50 pad_b_50">

        <x-web.page.subsection title="Novodobé dejiny">
