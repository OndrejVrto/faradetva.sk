    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) PART II -" class="static-page pad_t_50 pad_b_50">
        ...
        <x-web.page.subsection title="Novodobé dejiny">
            <x-web.page.text-segment animation="fromleft">
                ...
                <p>
                    Súčasná rozloha detvianskej farnosti nadobudla rozsah takmer 70 km<sup>2</sup>. Okrem samotného mesta zahŕňa miestne časti (osady a&nbsp;lazy): Chrapková, Chvostiná, Kostolná, Krné, Laštek, Majerovo, Piešť I., Piešť II., Skliarovo, Sliacka Poľana, Stavanisko, Rakytné a&nbsp;Za Priechody. Počet obyvateľov farnosti sa pohybuje okolo 14 000, z&nbsp;toho je približne 9 000 rímskokatolíkov. Farár vo farnosti je v&nbsp;súčasnosti aj dekanom detvianskeho dekanátu. Dlhoročne pôsobili v&nbsp;Detve popri farárovi dvaja kapláni, avšak od roku 2019 supluje vo farnosti úlohu druhého kaplána výpomocný duchovný.
                </p>
