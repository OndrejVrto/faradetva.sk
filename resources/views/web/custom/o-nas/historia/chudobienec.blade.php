<x-web.layout.master :pageData="$pageData">
    ...
    <x-web.page.subsection>
        ...
        <x-web.page.text-segment animation="fromleft">
            <p>
                Dnes sa veľká sála chudobienca využíva na mestské či cirkevné akcie, ako sú ochotnícke divadlá, zábavy, karnevaly, akciový predaj tovaru, prednášky a pod. Niektoré miestnosti má v užívaní folklórny súbor Podpoľanec, ktorý vo veľkej sále pravidelne nacvičuje. Z južnej strany, kde bol byt organistu, dal dekan Ľuboš Sabol prebudovať priestory na pastoračné centrum, ktoré 25. júna 2005 požehnal pomocný biskup Tomáš Galis. Pastoračné centrum má kuchynku, športovú miestnosť na pingpong i stolný futbal a spoločenskú miestnosť, ktorá sa využíva na stretnutia birmovancov, mládeže, snúbencov, katechétov, saleziánskych spolupracovníkov, terciárov sv. Františka a pod.
            </p>
        </x-web.page.text-segment>
    </x-web.page.subsection>
