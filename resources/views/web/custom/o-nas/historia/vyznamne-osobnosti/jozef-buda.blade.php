<x-web.layout.master :pageData="$pageData">
    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) -" class="static-page pad_b_50">
        ...
        <x-web.page.subsection>
            <x-web.page.text-segment animation="fromright">
                ...
                <x-partials.picture titleSlug="bud-013" side="left" dimensionSource="medium" columns="5"/>
    ...
    <x-web.sections.background-picture titleSlug="bud-003"/>
    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) PART II -" class="static-page pad_t_50 pad_b_50">
        <x-web.page.subsection>
            ...
            <x-web.page.text-segment animation="fromright">
                ...
                <x-partials.picture titleSlug="bud-006" side="left" dimensionSource="medium" columns="3"/>
            ...
            <x-web.page.text-segment animation="fromleft">
                ...
                <x-partials.picture titleSlug="bud-008" side="right" dimensionSource="medium" columns="4"/>
                ...
                <x-partials.picture titleSlug="bud-010" side="left" dimensionSource="medium" columns="3"/>
        ...
        <x-web.page.information-sources title="Použitá literatúra:">
            ...
            <li>BRENDZA, Gabriel, NEPŠINSKÝ, Vojtech, ĎURICA SJ, Ján, VOLEK, Peter. eds. <em>Život a dielo Jozefa Búdu. Zborník z vedeckého seminára pri príležitosti nedožitých stých narodenín prof. ThDr. Jozefa Búdu.</em> Badín: Kňazský seminár sv. Františka Xaverského, 1998. ISBN 80-88937-08-6.</li>
            <li>SLANÝ, Július. Búda Jozef. In: PAŠTEKA, Július. ed. <em>Lexikón katolíckych kňazských osobností Slovenska.</em> Bratislava: LÚČ, 2000. ISBN 80-7114-300-6.</li>
