<x-web.layout.master :pageData="$pageData">
    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) -" class="static-page pad_b_50">
        ...
        <x-web.page.subsection>
            <x-web.page.text-segment animation="fromright">
                ...
                <x-partials.picture titleSlug="med-020" side="left" dimensionSource="medium" columns="2"/>
                ...
                <x-partials.picture titleSlug="med-001" side="right" dimensionSource="medium" columns="3"/>
    ...
    <x-web.sections.background-picture titleSlug="med-020"/>
    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) PART II -" class="static-page pad_t_50 pad_b_50">
        ...
        <x-web.page.subsection>
            <x-web.page.text-segment animation="fromleft">
                ...
                <x-partials.picture titleSlug="med-003" side="left" dimensionSource="medium" columns="2"/>
                ...
                <x-partials.picture titleSlug="med-004" side="right" dimensionSource="medium" columns="3"/>
                ...
                <x-partials.picture titleSlug="med-009" side="left" dimensionSource="medium" columns="4"/>
                ...
                <x-partials.picture titleSlug="med-023" side="right" dimensionSource="medium" columns="4"/>
    ...
    <x-web.sections.background-picture titleSlug="med-014"/>
    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) PART II -" class="static-page pad_t_50 pad_b_50">
        ...
        <x-web.page.subsection>
            <x-web.page.text-segment animation="fromright">
                ...
                <x-partials.picture titleSlug="med-012" side="left" dimensionSource="medium" columns="4"/>
