<x-web.layout.master :pageData="$pageData">
    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) -" class="static-page pad_b_50">
        ...
        <x-web.page.subsection>
            <x-web.page.text-segment animation="fromright">
                ...
                <x-partials.picture titleSlug="vlk-001" side="left" dimensionSource="medium" columns="4"/>

                <h6 class="text-church-template">* <span class="ps-1 pe-2">20. 8. 1905</span> Drahovce (okr. Piešťany)</h6>
                <h6 class="text-church-template">† <span class="ps-1 pe-2">9. 5. 1975</span> Detva</h6>
            ...
            <x-web.page.text-segment animation="fromleft">
                ...
                <x-partials.picture titleSlug="vlk-010" side="right" dimensionSource="medium" columns="3"/>
                ...
                <x-partials.picture titleSlug="vlk-005" side="left" dimensionSource="medium" columns="3"/>
    ...
    <x-web.sections.background-picture titleSlug="vlk-002"/>
    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) PART II -" class="static-page pad_t_50 pad_b_50">
        <x-web.page.subsection>
            ...
            <x-web.page.text-segment animation="fromright">
                ...
                <x-partials.picture titleSlug="vlk-007" side="left" dimensionSource="medium" columns="5"/>
                ...
                <x-partials.picture titleSlug="vlk-006" side="right" dimensionSource="medium" columns="3"/>
                ...
                <x-partials.picture titleSlug="vlk-004" side="left" dimensionSource="medium" columns="4"/>
    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) PART III -" class="static-page pad_t_50 pad_b_50">
        <x-web.page.subsection>
            ...
            <x-web.page.text-segment animation="fromright">
                ...
                <x-partials.picture titleSlug="vlk-008" side="left" dimensionSource="medium" columns="4"/>
                ...
                <x-partials.picture titleSlug="vlk-016" side="right" dimensionSource="medium" columns="2"/>
                ...
                <x-partials.picture titleSlug="vlk-013" side="left" dimensionSource="medium" columns="4"/>
