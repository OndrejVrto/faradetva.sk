<x-web.layout.master :pageData="$pageData">
    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) -" class="static-page pad_b_50">
        ...
        <x-web.page.subsection>
            ...
            <x-web.page.text-segment animation="fromleft">
                ...
                <x-partials.picture titleSlug="zav-002" side="right" dimensionSource="medium" columns="2"/>
    ...
    <x-web.sections.background-picture titleSlug="zav-046"/>

    <x-web.page.section name="PAGE: ({{ $pageData->title }}) PART II -" class="static-page pad_t_50 pad_b_50">
        <x-web.page.subsection>
            <x-web.page.text-segment animation="fromleft">

                <x-partials.picture titleSlug="zav-014" side="right" dimensionSource="medium" columns="3"/>
        ...
        <x-web.page.subsection>
            <x-web.page.text-segment animation="fromright">
                <x-partials.picture titleSlug="zav-005" side="left" dimensionSource="medium" columns="3"/>
        ...
        <x-web.page.subsection>
            <x-web.page.text-segment animation="fromleft">
                ...
                <x-partials.picture titleSlug="zav-011" side="right" dimensionSource="medium" columns="3"/>
                ...
                <ul>
                    <li>údajne na pohrebnej kázni, keď pochovával tri dievčatá, ktoré zahynuli pri autohavárii v&nbsp;Prahe počas prázdninovej brigády, hovoril proti socialistickým brigádam;</li>
                    <li>počas primícií detvianskeho rodáka Jozefa Strapku, išiel z&nbsp;jeho rodného domu do kostola  slávnostný a&nbsp;početný krojovaný sprievod sprevádzaný cirkevnou hudbou;</li>
                    <li>v máji bolo na birmovke 600 detí;</li>
                    <li>tŕňom v&nbsp;oku bolo i&nbsp;postavenie novej farskej budovy, svojpomocne, bez finančného  príspevku štátu a&nbsp;za pomoci veriacich.</li>
                </ul>
    ...
    <x-web.sections.background-picture titleSlug="zav-007"/>
    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) PART III -" class="static-page pad_t_50 pad_b_50">
        ...
        <x-web.page.subsection>
            <x-web.page.text-segment animation="fromright">
                ...
                <x-partials.picture titleSlug="zav-016" side="left" dimensionSource="medium" columns="4"/>
                ...
                <x-partials.picture titleSlug="zav-020" side="right" dimensionSource="medium" columns="2"/>
        ...
        <x-web.page.information-sources title="Použitá literatúra a&nbsp;pramene:">
            ...
            <li>KONIAROVÁ, Anna, BRENDZA, Gabriel, GALIS, Tomáš, NEPŠINSKÝ, Vojtech. 200 rokov Kňazského seminára v&nbsp;Banskej Bystrici. Badín: Kňazský seminár sv. Františka Xaverského, 2007. ISBN 978-80-88937-28-9.</li>
            <li>Diecézny archív Banská Bystrica, f. Evidovaná pozostalosť zosnulých kňazov.</li>
