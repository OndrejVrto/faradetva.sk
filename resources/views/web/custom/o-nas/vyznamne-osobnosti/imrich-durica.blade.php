    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) -" class="static-page pad_b_50">
        ...
        <x-web.page.subsection>
            <x-web.page.text-segment animation="fromright">
                ...
                <x-partials.picture titleSlug="dur-006" side="left" dimensionSource="medium" columns="3"/>
    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) PART II -" class="static-page pad_t_50 pad_b_50">
        ...
        <x-web.page.subsection>
            ...
            <x-web.page.text-segment animation="fromleft">
                ...
                <x-partials.picture titleSlug="dur-016" side="left" dimensionSource="medium" columns="1"/>
        ...
        <x-web.page.information-sources title="Použitá literatúra a&nbsp;pramene:">
            <li>BRENDZA, Gabriel. ed. <em>Blahoslavení prenasledovaní pre spravodlivosť. Kňazi Banskobystrickej diecézy perzekvovaní totalitným režimom.</em> Badín: Kňazský seminár sv. Františka Xaverského, 2006. ISBN 80-88937-25-6.</li>
            <li>KOÓŠ, Mikuláš. ed.  <em>Imrich Ďurica. Výkrik.</em> Bratislava: AKVE, 2015. ISBN 978-80-972105-0-2.</li>
            <li>LETZ, Róbert. Ďurica Imrich. In: PAŠTEKA, Július. ed. <em>Lexikón katolíckych kňazských osobností Slovenska.</em> Bratislava: LÚČ, 2000. ISBN 80-7114-300-6.</li>
