<x-web.layout.master :pageData="$pageData">
    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) PART II -" class="static-page pad_t_50 pad_b_50">
        ...
        <x-web.page.information-sources title="Použitá literatúra a&nbsp;pramene:">
            ...
            <li>
                BRENDZA, Gabriel. ed.
                <em>Blahoslavení prenasledovaní pre spravodlivosť. Kňazi Banskobystrickej diecézy perzekvovaní totalitným režimom.</em>
                Badín: Kňazský seminár sv. Františka Xaverského, 2006. ISBN 80-88937-25-6.
            </li>

            <li>
                KOÓŠ, Mikuláš. ed.
                <em>Imrich Ďurica. Výkrik.</em>
                Bratislava: AKVE, 2015. ISBN 978-80-972105-0-2.
            </li>

            <li>
                LETZ, Róbert. Ďurica Imrich. In: PAŠTEKA, Július. ed.
