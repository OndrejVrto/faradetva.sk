    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }})PART I. - " class="static-page pad_b_50">
        ...
        <x-web.page.subsection>
            <x-web.page.text-segment animation="fromright">
                ...
                <x-partials.picture titleSlug="fk-057" side="left" dimensionSource="medium" columns="3" />
                ...
                <x-partials.picture titleSlug="belko-010" side="left" dimensionSource="medium" columns="4" />
        ...
        <x-web.page.subsection>
            <x-web.page.text-segment animation="fromleft">
                ...
                <x-partials.picture titleSlug="kronika-021" side="right" dimensionSource="medium" columns="4" />
                ...
                <x-partials.picture titleSlug="FK-005" side="left" dimensionSource="medium" columns="2" />
    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) PART II. -" class="static-page pad_t_50 pad_b_50">
        <x-web.page.subsection>
            ...
            <x-web.page.text-segment animation="fromright">
                ...
                <x-partials.picture titleSlug="fk-071" side="right" dimensionSource="medium" columns="3" />

                <p>
                    Okná sa vymenili za dvojité, farebné, vitrážové, z&nbsp;antického, katedrálneho skla, podľa výtvarných návrhov pátra Emila Prokopa SVD, rodáka z&nbsp;Kriváňa. Vo svätyni sú vo vitrážových oknách výjavy <em>Posledná večera</em> a&nbsp;<em>Dobrý pastier</em>, v&nbsp;hlavnej lodi kostola sú znázornení sv. Peter a&nbsp;sv. Pavol, v&nbsp;zadnej časti kostola sv. Dominik Savio a&nbsp;sv. Mária Goretti.
                </p>
            ...
            <x-web.page.text-segment animation="fromleft">
                ...
                <x-partials.picture titleSlug="fk-039" side="left" dimensionSource="medium" columns="1" />
    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) PART III. -" class="static-page pad_t_50 pad_b_50">
        <x-web.page.subsection>
            <x-web.page.text-segment animation="fromleft">
                ...
                <x-partials.picture titleSlug="fk-020" side="right" dimensionSource="medium" columns="5" />
                ...
                <x-partials.picture titleSlug="kronika-039" side="left" dimensionSource="medium" columns="2" />
                ...
                <x-partials.picture titleSlug="fk-078" side="right" dimensionSource="medium" columns="3" />
            ...
            <x-web.page.text-segment animation="fromright">
                ...
                <x-partials.picture titleSlug="fk-065" side="left" dimensionSource="medium" columns="3" />

                <p>
                    Dňa 26. apríla 1925 farár Ján Štrbáň požehnal tri nové zvony: I. 850 kg s&nbsp;nápisom <em>„Poďte, klaňajte sa sviatostnému Ježišovi, Pánovi neba i&nbsp;zeme;“</em> II. 547 kg s&nbsp;nápisom <em>„Slovo Telom sa stalo a&nbsp;prebývalo medzi nami;“</em> III. 27,80 kg umieráčik s&nbsp;nápisom <em>„Dobrotivý Pane Ježišu, daj mu (jej) pokoj večný.“</em> Na prelome 50. a&nbsp;60. rokov 20. storočia najväčší zvon z&nbsp;roku 1854 pukol a&nbsp;preto bol opakovane preliaty. Slávnostne ho v&nbsp;roku 1964 požehnal banskobystrický kapitulný vikár Ján Dechet.
                </p>
