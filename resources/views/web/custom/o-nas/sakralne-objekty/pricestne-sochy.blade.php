    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) -" class="static-page pad_b_50">
        ...
        <x-web.page.subsection >
            <x-web.page.text-segment animation="fromright">
                ...
                <x-partials.picture titleSlug="soch-023" side="left" dimensionSource="medium" columns="2" />

                <h3 class="mt-2 wow fromright" data-wow-delay="0.4s">Sv. Ján Nepomucký</h3>
            ...
            <x-web.page.text-segment animation="fromright">
                ...
                <x-partials.picture titleSlug="soch-003" side="right" dimensionSource="medium" columns="5" />

                <p>
                    Traduje sa, že svätý Ján je mučeníkom spovedného tajomstva. Údajne sa ho mal kráľ vypytovať na hriechy svojej manželky Žofie, ktorá bola veľmi nábožná. Spovedať sa chodila práve k Jánovi. Kráľ ju podozrieval z nevery, pretože sám sa tejto neresti dopúšťal. Keďže však Ján nič nevyzradil, mučil ho a dal nakoniec zabiť.
                    Túto tradíciu potvrdzuje aj fakt, že jazyk sv. Jána Nepomuckého sa zachoval neporušený. Za svätého bol vyhlásený v roku 1729. V nemecky hovoriacich krajinách sa jeho sviatok slávi 20. marca, avšak v Čechách a na Slovensku si ho osobitne uctievame 16. mája.
                </p>
        ...
        <x-web.page.subsection>
            <x-web.page.text-segment animation="fromleft">
                ...
                <x-partials.picture titleSlug="soch-021" side="left" dimensionSource="medium" columns="5" />
    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) PART II -" class="static-page pad_t_50 pad_b_50">
        <x-web.page.subsection title="Sv. Florián">
            <x-web.page.text-segment animation="fromright">
                ...
                <x-partials.picture titleSlug="soch-009b" side="left" dimensionSource="medium" columns="2" />

                <p>
                    Na severnom konci pôvodnej rozlohy centrálnej časti mestečka je zachovaná prícestná socha sv. Floriána, ktorú detviansky ľud familiárne nazýva „Florianko“, čo deti ľahko skomolia a ešte i dnes niektorí povedia: <em>„pri Froliankovi je odbočka na cintorín“</em>. Je to neskorobaroková kamenná, polychrómovaná socha z druhej polovice 18. storočia, naposledy renovovaná v roku 2019.
                </p>

                <x-partials.picture titleSlug="soch-019" side="right" dimensionSource="medium" columns="3" />
                ...
                <x-partials.picture titleSlug="soch-012" side="left" dimensionSource="medium" columns="2" />
