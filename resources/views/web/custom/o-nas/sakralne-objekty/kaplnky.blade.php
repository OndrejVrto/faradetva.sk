    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) -" class="static-page pad_b_50">
        ...
        <x-web.page.subsection title="Kaplnka Sedembolestnej Panny Márie - Piešť I. u Slobodov">
            <x-web.page.text-segment animation="fromleft">
                ...
                <x-partials.picture titleSlug="kusl-007" side="left" dimensionSource="medium" columns="2" />
                <x-partials.picture titleSlug="kusl-004" side="right" dimensionSource="medium" columns="3" />
        ...
        <x-web.page.subsection title="Kaplnka Sedembolestnej Panny Márie - Sliacka Poľana">
            <x-web.page.text-segment animation="fromright">
                ...
                <x-partials.picture titleSlug="slp-006" side="left" dimensionSource="medium" columns="2" />
                <x-partials.picture titleSlug="slp-002" side="right" dimensionSource="medium" columns="2" />
        ...
        <x-web.page.subsection title="Kaplnka Božieho milosrdenstva - Piešť I. u Svoreňov">
            <x-web.page.text-segment animation="fromleft">
                ...
                <x-partials.picture titleSlug="kusv-001" side="left" dimensionSource="medium" columns="12" />
        ...
        <x-web.page.subsection title="Kaplnka Panny Márie, Matky ustavičnej pomoci - Krné">
            <x-web.page.text-segment animation="fromright">
                ...
                <x-partials.picture titleSlug="krn-001" side="left" dimensionSource="medium" columns="4" />
    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) PART II -" class="static-page pad_t_50 pad_b_50">
        ...
        <x-web.page.subsection title="Meditačná kaplnka - Domov sociálnych služieb Detva, stredisko Piešť">
            <x-web.page.text-segment animation="fromright">
                ...
                <x-partials.picture titleSlug="dss-002" side="right" dimensionSource="medium" columns="2" />
                ...
                <x-partials.picture titleSlug="dss-001" side="left" dimensionSource="medium" columns="4" />

                <p>
                    Predmetom činnosti Strediska DSS Piešť je poskytovanie sociálnej služby zdravotne postihnutým občanom (mužom) s duševnými poruchami a poruchami správania celoročnou formou pobytu, s kapacitou 56 miest. Zariadenie tvoria dve budovy, ktoré sú spojené vestibulom.
                </p>
                <p>
        ...
        <x-web.page.subsection title="Božie muky">
            ...
            <x-partials.photo-gallery titleSlug="bozie-muky" dimensionSource="full" :viewDescription=false/>
