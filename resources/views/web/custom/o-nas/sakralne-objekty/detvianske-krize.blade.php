<x-web.layout.master :pageData="$pageData">
    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) -" class="static-page pad_b_50">
        ...
        <x-web.page.subsection >
            <x-web.page.text-segment animation="fromleft">
                ...
                <x-partials.picture titleSlug="dkriz-002" side="left" dimensionSource="medium" columns="2" />
                ...
                <x-partials.picture titleSlug="kriz-007" side="right" dimensionSource="medium" columns="3" />
                ...
                <x-partials.picture titleSlug="kriz-033" side="left" dimensionSource="medium" columns="4" />
                ...
                <div class="row">
                    <div class="col-md-6">
                        <x-partials.video-embed urlVideo="https://youtu.be/u53mcyV5MeM" class="ratio ratio-4x3"/>
                    </div>
                    <div class="col-md-6">
                        <x-partials.video-embed urlVideo="https://youtu.be/7T9hHtjaLSs" class="ratio ratio-4x3"/>
                    </div>
                </div>
    ...
    <x-web.sections.background-picture titleSlug="kriz-003"/>
    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) PART II -" class="static-page pad_t_50 pad_b_50">
        <x-web.page.subsection>
            <x-web.page.text-segment animation="fromright">
                ...
                <x-partials.picture titleSlug="kriz-008" side="left" dimensionSource="medium" columns="2" />
                ...
                <x-partials.picture titleSlug="dkriz-010" side="righnt" dimensionSource="medium" columns="1" />
    ...
    <x-web.sections.background-picture titleSlug="kriz-037"/>
    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) PART III -" class="static-page pad_t_50 pad_b_50">
        ...
        <x-web.page.information-sources title="Použitá literatúra:">
            ...
            <li>OSTRIHOŇOVÁ, Anna. Tradičná kultúra a jej premeny. In: Anna Ostrihoňová. ed. <em>Detva. Monografia mesta.</em> Detva: mesto Detva, 2018. ISBN 978-80-9730011-2-5.</li>
            <li>
                <em class="me-1">Detvianske drevené vyrezávané kríže</em>
                [online]. [cit. 19.03.2021].
                <a  class="link-template"
                    target="_blank"
                    href="https://www.detva.sk/?id_menu=85182">
