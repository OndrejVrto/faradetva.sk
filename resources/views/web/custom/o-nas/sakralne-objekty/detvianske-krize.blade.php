<x-web.layout.master :pageData="$pageData">
    ...
    <x-web.page.subsection >
        ...
        <x-web.page.text-segment animation="fromright">
            ...
            <p>
                V 18. storočí sa v Detve a okolí odrazil vývoj umeleckej úrovne drevených krížov v súvise s barokovým dekorativizmom sprevádzajúcim obdobie rekatolizácie, označujúc ho termínom zľudovený barok. Kríž si u zručných majstrov objednávali príbuzní zosnulého, pri pohrebe sa s úctou niesol pred rakvou a hneď sa osadil na hrob pri hlave zosnulého. Neprekvapuje preto, že vo výzdobe krížov prevažujú náboženské motívy. Popri univerzálne rozšírenej iniciále IHS (skratka mena Ježiš v gréčtine) sa objavuje motív viniča, srdca, Oltárnej sviatosti, kalicha s hostiou a sviec. Obvyklou súčasťou výzdoby boli tiež rastlinné ornamenty (kvety, halúzky), volúty, točené stĺpiky, solárne motívy, rovnako ako krátke nápisy s menom a dátami zosnulého.
            </p>
    ...
    <x-web.page.subsection>
        ...
        <x-web.page.text-segment animation="fromleft">
            ...
            <ul>
                <li>V Kostolnej dal nový drevený kríž zhotoviť Štefan Gonda - Spižiak. Bol posvätený 25. mája 1910 za účasti procesie, ktorá išla z kostola až do Kostolnej.</li>
                <li>Pod tureckým vŕškom v Piešti bol postavený nový drevený kríž, ktorý bol posvätený pri procesii 27. júla 1913.</li>
                <li>Farár Anton Kúdelka v roku 1934 požehnal tri kríže. Jeden 15. augusta pri chotári Podkriváň u Dančov, dva 16. septembra pri detvianskom kostole, z ktorých postavený poniže kostola darovala pani Antónia Vagačová a kríž povyše kostola bol zadovážený z milodarov.</li>
                <li>Dňa 15. augusta 1938 bol požehnaný nový kríž na Kaľamárke, 15. júna 1941 pred školou na Stavanisku, 27. júna 1943 pred novou školou v Skliarove a v Krivci taktiež pri škole.</li>
            </ul>
        </x-web.page.text-segment>
    </x-web.page.subsection>
    ...
    <x-web.page.subsection>
        ...
        <x-web.page.text-segment animation="fromright">
            ...
            <ul>
                <li>Dňa 2. novembra 1993 farár Pavol Zemko posvätil kríž pred farou, ktorý na želanie poslednej vôle zosnulého dekana Jozefa Závodského zhotovil Mikuláš Sekereš zo sídliska, vo svojej dielni u svokrovcov v starej Detve.</li>
                <li>24. októbra 1999 bol požehnaný novopostavený kríž na Skliarove - Spúšťanke.</li>
                <li>Na slávnosť sv. Cyrila a Metoda v roku 2002 bola svätá omša  pred mestským úradom na sídlisku, počas ktorej dekan Roman Furek požehnal novopostavený kríž.</li>
            </ul>
        </x-web.page.text-segment>
    </x-web.page.subsection>
    ...
    <x-web.page.subsection>
        ...
        <x-web.page.text-segment animation="fromleft">
            ...
            <p>
                Zo súčasnej generácie miestnych výrobcov sú to najmä diela Jozefa Krnáča ml., Mikuláša Purdeka, Jána Môťovského, Štefana Melicha, Štefana Ľuptáka a ďalších. Reštaurovaniu krížov a výrobe malých stolových krížov a miniatúrnych príveskových krížikov, ktoré sú napodobeninami tradičných prícestných krížov, sa venuje Milan Malček z Detvianskej umeleckej kolónie, o.z.
            </p>
        </x-web.page.text-segment>
    </x-web.page.subsection>
    ...
    <x-web.page.information-sources title="Použitá literatúra:">
        ...
        <li>OSTRIHOŇOVÁ, Anna. Tradičná kultúra a jej premeny. In: Anna Ostrihoňová. ed. Detva. Monografia mesta. Detva: mesto Detva, 2018. ISBN 978-80-9730011-2-5.</li>
        <li>Detvianske drevené vyrezávané kríže [online]. [cit. 19.03.2021]. Dostupné na internete: https://www.detva.sk/?id_menu=85182</li>
