    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) -" class="static-page pad_b_50">
        ...
        <x-web.page.subsection>
            <x-web.page.text-segment animation="fromright">
                ...
                <x-partials.picture titleSlug="hos-028" side="left" dimensionSource="medium" columns="4" />
        ...
        <x-web.page.subsection class="mt-5">
            <x-web.page.text-segment animation="fromright">
                ...
                <a target="_blank" rel="external noopener noreferrer" href="https://www.facebook.com/groups/1427727460859304">Facebook zboru.</a>
        ...
        <x-web.page.subsection class="mt-5">
            <x-web.page.text-segment animation="fromright">
                ...
                <a target="_blank" rel="external noopener noreferrer" href="https://www.facebook.com/hosannadetva">Facebook zboru.</a>
        ...
        <x-web.page.information-sources title="Použitá literatúra a&nbsp;prameň:">
            ...
            <x-web.page.source-link
                date="02.03.2021"
                href="https://www.detva.sk/?id_kat_for_menu=22717&module_action__266751__id_ci=186807">
                    Na oslavu storočnice pozýva Cirkevná dychová hudba v&nbsp;Detve
            </x-web.page.source-link>
