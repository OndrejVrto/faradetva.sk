<x-web.layout.master :pageData="$pageData">
    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) -" class="static-page pad_b_50">
        ...
        <x-web.page.subsection>
            <x-web.page.text-segment animation="fromleft">
                ...
                <x-partials.picture titleSlug="lekt-002" side="right" dimensionSource="medium" columns="2" />
            ...
            <x-web.page.text-segment animation="fromleft">
                ...
                <x-partials.picture titleSlug="lekt-007" side="left" dimensionSource="medium" columns="4" />

                <p>
                    Znovuobjavený význam lektorátu a&nbsp;akolytátu nie je len vo vzťahu k&nbsp;sviatostnému kňazstvu, ale tiež a&nbsp;predovšetkým v&nbsp;súvislosti s&nbsp;krstným kňazstvom. Existuje aj suplovaná úloha lektora, ktorú môžeme nazvať <em>mimoriadny čitateľ Božieho slova</em> - ním môžu byť ženy, muži, mládež, a&nbsp;títo síce nie sú svojím ordinárom ustanovenými lektormi, ale majú od svojho správcu farnosti dovolenie čítať lekcie Svätého písma vo svätej omši.
                </p>
    ...
    <x-web.sections.background-picture titleSlug="lekt-013"/>
        ...
        <x-web.page.subsection>
            <x-web.page.text-segment animation="fromleft">
                ...
                <ol class="list-of-rules">
                    ...
                    <x-partials.picture titleSlug="lekt-010" side="right" dimensionSource="medium" columns="5" class="mt-4"/>
