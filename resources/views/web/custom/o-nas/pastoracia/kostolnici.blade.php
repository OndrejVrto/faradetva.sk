    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) -" class="static-page pad_b_50">
        ...
        <x-web.page.subsection >
            <x-web.page.text-segment animation="fromright">
                ...
                <x-partials.picture titleSlug="kost-001" side="left" dimensionSource="medium" columns="3" />
                ...
                <x-partials.picture titleSlug="kost-015" side="right" dimensionSource="medium" columns="2" />
