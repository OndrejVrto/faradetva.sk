<x-web.layout.master :pageData="$pageData">
    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) -" class="static-page pad_b_50">
        ...
        <x-web.page.subsection >
            ...
            <x-partials.picture titleSlug="mini-003" side="left" dimensionSource="medium" columns="5" />
        ...
        <x-web.page.subsection>
            ...
            <x-partials.picture titleSlug="mini-001" side="right" dimensionSource="medium" columns="5" />
    ...
    <x-web.sections.background-picture titleSlug="mini-009"/>

    <x-web.page.section name="PAGE: ({{ $pageData->title }}) PART II. -" class="static-page pad_t_50 pad_b_50">

        <x-web.page.subsection title="Aký má byť miništrant">

            <x-web.page.text-segment animation="fromleft">

                <x-partials.picture titleSlug="mini-011" side="right" dimensionSource="medium" columns="3" />
        ...
        <x-web.page.subsection title="Miništranti v&nbsp;Detve">

            <x-partials.picture titleSlug="mini-006" side="left" dimensionSource="medium" columns="4" />
        ...
        <x-web.page.information-sources title="Použitá literatúra:">
            <li>MIKLÚŠ, František. <em>Miništranti. Príručka pre miništrantov.</em> Trnava: Spolok sv. Vojtecha, 2009. ISBN 978-80-7162-773-9.</li>
