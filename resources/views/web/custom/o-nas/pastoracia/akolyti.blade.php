<x-web.layout.master :pageData="$pageData">
    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) -" class="static-page pad_b_50">
        ...
        <x-web.page.subsection>
            ...
            <x-partials.picture titleSlug="akol-002" side="left" dimensionSource="medium" columns="2" />
            <x-partials.picture titleSlug="akol-004" side="right" dimensionSource="medium" columns="3" />
        ...
        <x-web.page.subsection>
            ...
            <x-partials.picture titleSlug="akol-008" side="left" dimensionSource="medium" columns="4" />
            ...
            <x-web.page.text-segment animation="fromright">
                ...
                <x-partials.picture titleSlug="akol-003" side="right" dimensionSource="medium" columns="5" />
            ...
            <x-web.page.text-segment animation="fromleft">
                <ol class="row ps-4">
                    <div class="col">
                        ...
                        <li>Ján Fekiač</li>
                        <li>Ondrej Orság</li>
                        <li>Mikuláš Bystriansky</li>
                    </div>

                    <div class="col">
                        <h6 class="text-church-template">Mimoriadni rozdávatelia</h6>
