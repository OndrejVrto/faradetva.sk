    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) -" class="static-page pad_b_50">
        ...
        <x-web.page.subsection title="Farská ekonomická rada">
            <x-web.page.text-segment animation="fromleft">
                ...
                <ol>
                    <li>Ing. Eva Bohumeľová</li>
                    <li>Ing. Mária Budáčová</li>
                    <li>Ing. Marián Fekiač, PhD.</li>
                    <li>Ing. Darina Krekáňová</li>
                    <li>Ing. Vladimír Kučera</li>
                    <li>Katarína Luptáková</li>
                </ol>

            </x-web.page.text-segment>
        </x-web.page.subsection>

        <x-web.page.subsection title="Farská pastoračná rada">
            <x-web.page.text-segment animation="fromright">
                ...
                <div class="float-start ml-5">
                    ...
                    <h6 class="h6 text-church-template">
                        Zvolení členovia farskej pastoračnej rady od roku 2020
                    </h6>

                    <ol class="row">
                        <div class="col">
                            <li>Mgr. Katarína Budáčová</li>
                            <li>Ing. Mikuláš Bystriansky</li>
                            <li>Ján Fekiač</li>
                            <li>Mgr. Ľubomír Fekiač</li>
                            <li>Mgr. Jana Kuzárová</li>
                            <li>Ing. Jozef Murín</li>
                            <li>Ondrej Orság ml.</li>
                        </div>
                        <div class="col">
                            <li>Milan Porubský</li>
                            <li>Mgr. Lucia Spodniaková</li>
                            <li>Jozef Strelec</li>
                            <li>Bc. Valéria Škopíková</li>
                            <li>Ing. Ján Šufliarsky</li>
                            <li>Ing. Ondrej Vrťo</li>
                            <li>Emília Žubrietovská</li>
                        </div>
                    </ol>
        ...
        <x-web.page.information-sources title="Použité pramene:">
            ...
            <li>
                <em>Štatút Farskej pastoračnej rady.</em>
                Banskobystrická diecéza. Biskupstvo Banská Bystrica, 2001.
            </li>

            <li>
                <em>Štatút farských ekonomických rád v&nbsp;Banskobystrickej diecéze.</em>
                Biskupstvo Banská Bystrica, 2014.
            </li>
