<x-web.layout.master :pageData="$pageData">
    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) PART II. -" class="static-page pad_t_50 pad_b_50">
        ...
        <x-web.page.information-sources title="Použitá literatúra:">
            ...
            <li>
                KOSTELANSKÝ, Alojz.
                <em>Aktivizačné a&nbsp;tvorivé metódy vo vyučovaní náboženskej výchovy.</em>
                Ružomberok: Pedagogická fakulta Katolíckej univerzity v&nbsp;Ružomberku, 2008. ISBN 978-80-8084-383-0.
            </li>

            <li>
                VALOVIČ, Eugen.
                <em>Náčrt katechetiky I.</em>
                Bratislava: Dobrá kniha, 1999. ISBN 80-7141-281-3.
            </li>

            <li>
                <em>Katechizmus Katolíckej cirkvi.</em>
                3. vydanie. Trnava: Spolok sv. Vojtecha, 2002. ISBN 80-7162-370-9.
            </li>

            <li>
                <em>Všeobecné direktórium pre katechizáciu.</em>
                Trnava: Spolok sv. Vojtecha, 1999. ISBN 80-7162-264-8.
            </li>
