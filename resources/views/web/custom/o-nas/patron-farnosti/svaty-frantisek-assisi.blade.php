<x-web.layout.master :pageData="$pageData">
    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) PART I -" class="static-page pad_b_50">
        ...
        <x-web.page.subsection >
            <x-web.page.text-segment animation="fromright">
                ...
                <x-partials.picture titleSlug="patr-013" side="left" dimensionSource="medium" columns="3" />
        ...
        <x-web.page.subsection title="Mladosť">
            <x-web.page.text-segment animation="fromleft">

                <x-partials.picture titleSlug="patr-015" side="right" dimensionSource="medium" columns="3" />
                ...
                <x-partials.picture titleSlug="patr-006" side="left" dimensionSource="medium" columns="2" />
    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) PART II -" class="static-page pad_t_50 pad_b_50">
        ...
        <x-web.page.subsection title="Povolanie">
            <x-web.page.text-segment animation="fromleft">
                ...
                <x-partials.picture titleSlug="patr-008" side="left" dimensionSource="medium" columns="2" />
                ...
                <x-partials.picture titleSlug="patr-014" side="right" dimensionSource="medium" columns="4" />
        ...
        <x-web.page.subsection title="Františkánske spoločenstvo">
            <x-web.page.text-segment animation="fromright">

                <x-partials.picture titleSlug="patr-017" side="left" dimensionSource="medium" columns="2" />
                ...
                <x-partials.picture titleSlug="patr-020" side="right" dimensionSource="medium" columns="2" />
    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) PART III -" class="static-page pad_t_50 pad_b_50">
        ...
        <x-web.page.subsection title="Apoštolát">
            <x-web.page.text-segment animation="fromleft">
                ...
                <x-partials.picture titleSlug="patr-007" side="right" dimensionSource="medium" columns="3" />
                ...
                <x-partials.picture titleSlug="patr-011" side="left" dimensionSource="medium" columns="2" />
        ...
        <x-partials.photo-gallery titleSlug="svaty-fratisek-z-asiisi" dimensionSource="medium"/>

        <x-web.page.subsection title="Posledné roky života" class="pad_t_50">
            <x-web.page.text-segment animation="fromright">
                ...
                <p>
                    V&nbsp;septembri 1224 sa pred sviatkom sv.&nbsp;Michala utiahol František do samoty na hore Verna neďaleko Arezza, kde sa postil, rozjímal a&nbsp;usiloval sa čím užšie spojiť s&nbsp;trpiacim Vykupiteľom. Tu sa mu ráno 14. septembra, na sviatok povýšenia Svätého kríža, zjavil ukrižovaný Kristus v&nbsp;podobe okrídleného serafína a&nbsp;vtlačil mu do tela znaky svojich rán - stigmy. Bol to prvý známy prípad stigiem v&nbsp;dejinách Cirkvi. Krvavé znaky Kristovho utrpenia boli viditeľné na Františkových rukách, nohách a&nbsp;boku tak za jeho života, ako aj po jeho smrti.
                </p>

                <p>
                    Zo samoty La Verny sa František vrátil premenený mimoriadnym mystickým zážitkom. No zvláštne milosti ho neušetrili od stále vzrastajúcich telesných bolestí. K&nbsp;utrpeniu stigiem sa pripájali zosilnené bolesti žalúdka, pečene a&nbsp;postupujúca očná choroba, ktorú nezastavili ani drastické zásahy, aké praktizovali vtedajší lekári. Bolo vidieť, že František sa blíži k&nbsp;vrcholu svojej životnej kalvárie.
                </p>

                <x-partials.picture titleSlug="patr-012" side="left" dimensionSource="medium" columns="4" />

                <p>
                    Napriek tomu sa chcel znova vybrať na apoštolské cesty, ale jeho telesné sily mu to už nedovolili. Preto sa sústredil na povzbudzovanie spolubratov a&nbsp;všetkých ľudí, s&nbsp;ktorými sa mohol nejako dostať do styku. Už takmer slepý zostavil v&nbsp;Assisi na prelome rokov 1224 - 1225 známu prekrásnu Pieseň brata Slnka, v&nbsp;ktorej dobrorečí Bohu za všetky stvorenia a&nbsp;vyzdvihuje ich užitočnosť a&nbsp;krásu.
                </p>
    ...
    <x-web.page.section name="PAGE: ({{ $pageData->title }}) PART I V&nbsp;-" class="static-page pad_t_50 pad_b_50">
