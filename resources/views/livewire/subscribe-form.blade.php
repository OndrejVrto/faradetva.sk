        ...
        <form wire:submit.prevent="submitForm">
            ...
            <div class="row">
                <div class="col-lg-4 form-group">
                    <input id="liveware-register-name" wire:model.lazy="name" type="text" name="name" autocomplete="on" placeholder="Vaše celé meno" value="{{ old('name') }}">
                    @error('name')
                ...
                <div class="col-lg-5 mt-3 mt-lg-0 form-group">
                    <input id="liveware-register-email" wire:model.lazy="email" type="text" name="email" autocomplete="on" placeholder="Váš E-mail" value="{{ old('name') }}">
                    @error('email')
                        <span class="text-church-template-blue d-block mt-1 ms-4" role="alert">
