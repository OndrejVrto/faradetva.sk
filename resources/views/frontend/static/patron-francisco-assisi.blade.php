...
<div class="section static-page pad_t_50 pad_b_50">
	<div class="container">
		...
		<x-sections-page >
			<x-sections-page.img columns="4" type="left" alt="" url="{{ URL::asset('images/only-for-debug/sv-francisco/images.jpg') }}" />
		...
		<x-sections-page title="Mladosť">
			...
			<x-sections-page.img columns="4" type="left" alt="" url="{{ URL::asset('images/only-for-debug/sv-francisco/Josep_Benlliure_Gil43.jpg')  }}" />
			<x-sections-page.text type="right">
				<p>
		...
		<x-sections-page title="Dianie po smrti">
			...
			<x-sections-page.img columns="4" type="left" alt="" url="{{ URL::asset('images/only-for-debug/sv-francisco/WEB3-SAINT-FRANCIS-OF-ASSISI-SHEPHERD-SHEEP-WOLF-shutterstock_710430052.jpg')  }}" />
			<x-sections-page.text type="right">
				<p>
