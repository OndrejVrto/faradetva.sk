...
@push('content_prepend')
	@include('frontend._sections.banner', ['mainTitle' => 'Svätý František z Assisi'])
@endpush
...
<div class="section static-page pad_t_50 pad_b_50">
	<div class="container">
		...
		<div class="row mt-3">
			<div class="clearfix">
				<img class="img-fluid col-md-6 col-lg-4 mb-3 me-sm-4 float-sm-start rounded-3 fromleft wow" src="{{ URL::asset('images/only-for-debug/sv-francisco/images.jpg')  }}" alt="">

				<div class="fromright wow">
					<h6>* 1181/1182 Assisi, Taliansko</h6>
					<h6>† 3.10.1226 Kostol Porciunkula, dnes Bazilika Santa Maria degli Angeli pri Assisi, Taliansko</h6>
					<p>
		...
		<div class="row mt-3">
			<h3 class="fromright wow" data-wow-delay="0.4s">Mladosť</h3>
			<div class="clearfix">

				<img class="img-fluid col-md-6 col-lg-4 mb-3 ms-sm-4 float-sm-end rounded-3 fromright wow" src="{{ URL::asset('images/only-for-debug/sv-francisco/602199.jpg') }}" alt="">

				<div class="fromleft wow">
					<p>
				...
				<img class="img-fluid col-md-6 col-lg-4 mb-3 me-sm-4 float-sm-start rounded-3 fromleft wow" src="{{ URL::asset('images/only-for-debug/sv-francisco/Josep_Benlliure_Gil43.jpg') }}" alt="">
		...
		<div class="row mt-3">
			<h3 class="fromright wow" data-wow-delay="0.4s">Povolanie</h3>
			<div class="clearfix">

				<img class="img-fluid col-md-4 col-lg-3 mb-3 ms-sm-4 float-sm-end rounded-3 fromright wow" src="{{ URL::asset('images/only-for-debug/sv-francisco/Saint_Francis_of_Assisi_by_Jusepe_de_Ribera.jpg') }}" alt="">
				...
				<div class="fromleft wow">
					...
					<img class="img-fluid col-md-3 col-lg-2 mb-3 me-sm-4 float-sm-start rounded-3" src="{{ URL::asset('images/only-for-debug/sv-francisco/11008.jpg') }}" alt="">
					<p>
		...
		<div class="row mt-3">
			<h3 class="fromright wow" data-wow-delay="0.4s">Františkánske spoločenstvo</h3>
			<div class="clearfix">
				<img class="img-fluid col-md-4 col-lg-3 mb-3 me-sm-4 float-sm-start rounded-3 fromleft wow" src="{{ URL::asset('images/only-for-debug/sv-francisco/StFrancis_part.jpg') }}" alt="">
		...
		<div class="row mt-3">
			<h3 class="fromright wow" data-wow-delay="0.4s">Apoštolát</h3>
			<div class="clearfix">

				<img class="img-fluid col-md-4 col-lg-3 mb-3 ms-sm-4 float-sm-end rounded-3 fromright wow" src="{{ URL::asset('images/only-for-debug/sv-francisco/st_francis_of_assisi_receiving_the_stigmata-12701.jpg') }}" alt="">
		...
		<div class="row mt-3">
			<h3 class="fromright wow" data-wow-delay="0.4s">Posledné roky života</h3>
			<div class="clearfix">
				<img class="img-fluid col-md-6 col-lg-4 mb-3 me-sm-4 float-sm-start rounded-3 fromleft wow" src="{{ URL::asset('images/only-for-debug/sv-francisco/1627905656-porciunkula (1).jpg') }}" alt="">
		...
		<div class="row mt-3">
			<h3 class="fromright wow" data-wow-delay="0.4s">Dianie po smrti</h3>
			<div class="clearfix">

				<img class="img-fluid col-md-6 col-lg-4 mb-3 ms-sm-4 float-sm-end rounded-3 fromright wow" src="{{ URL::asset('images/only-for-debug/sv-francisco/francis_and_first_followers_690.jpg') }}" alt="">
				...
				<img class="img-fluid col-md-6 col-lg-4 mb-3 me-sm-4 float-sm-start rounded-3 fromleft wow" src="{{ URL::asset('images/only-for-debug/sv-francisco/WEB3-SAINT-FRANCIS-OF-ASSISI-SHEPHERD-SHEEP-WOLF-shutterstock_710430052.jpg') }}" alt="">
