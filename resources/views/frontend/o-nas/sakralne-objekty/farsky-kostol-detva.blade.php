<x-frontend.layout.master :pageData="$pageData">
    ...
    <x-frontend.page.subsection>
        <x-frontend.page.text-segment type="right">
            <p>
                Prvý a pôvodný renesančný kostol zasvätený sv. Františkovi Serafínskemu (Assiskému) bol v Detve postavený už v roku 1664. Hoci bol pomerne veľký, svojmu účelu slúžil len 150 rokov. Pre rýchly populačný prírastok obyvateľstva, už koncom 18. storočia početným veriacim nestačil. Preto ho zbúrali a na jeho mieste v rokoch 1803 - 1806 postavili nový, väčší, dodnes zachovaný kostol v klasicistickom štýle. Stavbu kostola realizoval detviansky farár, dekan a honorárny kanonik Ján Dlholuczký. Ním bol nový kostol požehnaný a do užívania uvedený 30. novembra 1806. V ten istý deň bol v ňom ako prvý pokrstený istý Ondrej Gonda. Až po skompletizovaní celkového vybavenia interiéru konsekroval kostol 18. mája 1823 banskobystrický diecézny biskup Anton Makay. Zo starého renesančného kostola do novostavby prevzali len vežu, ktorú dal farár Ján Štrba v roku 1829 nadstaviť a pokryť meďou.
            </p>
    ...
    <x-frontend.page.subsection>
        <x-frontend.page.text-segment type="right">
            <p>
                V roku 1978 si kostol vyžadoval opäť generálnu opravu. Eternit na streche už bol na mnohých miestach poškodený, takže do kostola zatekalo. Strechu prekryli medeným plechom. Prácu uskutočnil miestny majster Vincent Chamula so svojou skupinou. Poškodená bola i vonkajšia fasáda kostola, ktorý nanovo omietol majster Halaj z Kriváňa. Celá oprava si vyžiadala takmer milión korún. V Historii domus farár Martin Láclavík vyzdvihol pracovitosť i štedrosť svojich farníkov: „S úhradou som nemal žiadne starosti. Ľudia ochotne dávali milodary a pomáhali pri prácach bez toho, žeby som bol musel pýtať peniaze.“
            </p>
        </x-frontend.page.text-segment>
        <x-frontend.page.text-segment type="left">
            <p>
                Po oprave exteriéru sa v rokoch 1987 - 1989 pristúpilo k renovácii interiéru kostola. Obnovu výmaľby uskutočnilo výrobné družstvo Svojpomoc z Trenčína. Zrealizovala sa vodovodná prípojka do sakristie, nová elektroinštalácia, izolácia klenby kostola sklenou vatou a položila sa nová dlažba z prírodného kameňa (spišský travertín). Pri zadnom vchode sa osadila kovaná brána, zakúpilo sa 8 keramických pecí. Okná sa vymenili za dvojité, farebné, vitrážové, z antického, katedrálneho skla, podľa výtvarných návrhov pátra Emila Prokopa SVD, rodáka z Kriváňa. Vo svätyni sú vo vitrážových oknách výjavy Posledná večera a Dobrý pastier, v hlavnej lodi kostola sú znázornení sv. Peter a sv. Pavol, v zadnej časti kostola sv. Dominik Savio a sv. Mária Goretti. Pri maľovaní kostola, najmä stropu interiéru, pomáhal aj verbista Emil Prokop. Očistil tri stropné olejomaľby: Nanebovzatie Panny Márie vo svätyni, Pán Ježiš v Getsemanskej záhrade a Posledná večera v lodi kostola. V rámci výmaľby kostola boli prečistené tri oltárne obrazy a v roku 1990 boli okolo nich osadené nové vyrezávané a pozlátené rámy, ktoré zhotovil majster Ondrej Marko z Hriňovej.
            </p>
        </x-frontend.page.text-segment>
    </x-frontend.page.subsection>
    ...
    <x-frontend.page.subsection>
        <x-frontend.page.text-segment type="right">
            <p>
                Hlavný klasicistický oltár zdobený stĺpmi korintského štýlu pochádza z roku 1823. Obkolesuje ho pozlátený oblúk s ornamentálnou dekoráciou, pripomínajúcou vínnu révu. Uprostred sa nachádza oltárny obraz sv. Františka z Assisi. Nad ním je umiestnený oltárny nadstavec s obrazom Najsvätejšej Trojice z roku 1823. Z toho istého roku pochádzal aj hlavný oltárny obraz smrti sv. Františka. Ten bol neskôr nahradený novým obrazom naznačujúcim stigmatizáciu sv. Františka, ktorý v roku 1936 namaľoval František Gyurkovits z Lučenca. Ústredný oltárny obraz znázorňuje scénu Ukrižovaného Krista, ktorý sa pravou časťou tela skláňa k sv. Františkovi. František je oblečený v obvyklom františkánskom odeve, prijíma Pána Ježiša veľmi úctivým pohľadom a gestom. Jeho zdvihnutá ľavá ruka upozorňuje na dôležitú udalosť prijatia stigiem - rán Kristovho umučenia, ktoré sv. František natrvalo nadobudol v roku 1224 pri uprenej meditácii a modlitbe.
            </p>
        </x-frontend.page.text-segment>
        <x-frontend.page.text-segment type="left">
            <p>
                V priečnej lodi sa nachádzajú dva bočné oltáre. Ľavý bočný oltár je taktiež klasicistický, z prvej polovice 19. storočia, s obrazom smrti sv. Františka z Assisi. Na tomto oltári bola v roku 1916 umiestnená socha Najsvätejšieho Srdca Ježišovho, zakúpená Antóniou Vagačovou od Mayerische Kunstantstattu z Mníchova. Od roku 2014 sa na tomto bočnom oltári nachádza aj miniatúrna podobizeň i relikvia sv. Faustíny Kowalskej. Bočný oltár napravo s obrazom sv. Jána Nepomuckého je taktiež datovaný do prvej polovice 19. storočia. V roku 1963 bola v Červenom Kostelci zakúpená socha Nepoškvrneného srdca Panny Márie, ktorá bola umiestnená na tomto oltári. Od tej istej firmy z Červeného Kostelca bol dekanom Láclavíkom objednaný v roku 1965 aj dodnes používaný vianočný betlehem, s pastiermi v podpolianskom kroji. Po bokoch lode kostola sa ešte nachádza na ľavej strane socha sv. Jozefa, ženícha Panny Márie a na pravej strane socha sv. Terézie z Lisieux. Ďalšie sochy sv. Júdu Tadeáša a sv. Antona Paduánskeho sú umiestnené pod chórom.
            </p>
        </x-frontend.page.text-segment>
    </x-frontend.page.subsection>
    ...
    <x-frontend.page.subsection>
        <x-frontend.page.text-segment type="right">
            <p>
                V roku 1854 dal farár Ján Štrba uliať nový zvon u Vojtecha Littmanna v Banskej Bystrici, ktorý vo Svätom Kríži nad Hronom posvätil národne zmýšľajúci banskobystrický biskup Štefan Moyses. Požiarom z roku 1895 bola poškodená väzba zvonov, nedržala zvony pevne, preto bola v roku 1911 zhotovená nová železná väzba u Ladislava Slezáka v Pešti. Kostolné zvony počas prvej svetovej vojny postihli dve rekvirácie. V roku 1916 vzali na vojenské ciele tri menšie zvony, pričom jeden bol z kalvárie. V roku 1917 zobrali z kostolnej veže ďalšie tri zvony. Keď 686 kg ťažký medián odliaty v roku 1911 zhodili z veže, vôbec nepraskol, dokonca rozbil skalu pri vchode kostola. Druhý zvon, na ktorý bili hodiny, vážil 121 kg a tretí umieráčik 22 kg. Farár Anton Kúdelka dal následne preniesť z Piešťa 60 kg zvon namiesto umieráčika. Zvony na lazoch neuviedol do výkazu a najväčší zvon prelievaný v roku 1854, podľa vlastných slov zachránil „iba fígľom“. Svojím odvážnym počínaním mohol podľa vojenských zákonov zaplatiť aj životom.
            </p>
        </x-frontend.page.text-segment>
        <x-frontend.page.text-segment type="left">
            <p>
                Dňa 26. apríla 1925 dekan Ján Štrbáň požehnal tri nové zvony: I. 850 kg s nápisom „Poďte, klaňajte sa sviatostnému Ježišovi, Pánovi neba i zeme;“ II. 547 kg s nápisom „Slovo Telom sa stalo a prebývalo medzi nami;“ III. 27,80 kg umieráčik s nápisom „Dobrotivý Pane Ježišu, daj mu (jej) pokoj večný.“ Najväčší zvon opäť pukol v roku 1964 a farár Láclavík ho dal opakovane preliať. Zvony boli elektrifikované v roku 1975, čo zabezpečilo družstvo Portáš z Moravy. Zhotovili aj novú stolicu pod zvony. V letných mesiacoch roka 2014 sa vykonala generálna oprava zvonov a vežových hodín, ktorú uskutočnila Zvonárska dielňa Albína Iváka z Liptovských Sliačov. Tá istá dielňa v roku 2020 zabezpečila aj výmenu ciferníkov vežových hodín.
            </p>
        </x-frontend.page.text-segment>
    </x-frontend.page.subsection>
