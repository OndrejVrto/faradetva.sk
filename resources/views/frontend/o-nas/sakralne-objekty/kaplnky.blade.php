...
@section('content')
    <x-page-section title="Kaplnka Sedembolestnej Panny Márie - Kalvária">
    ...
    <x-page-section title="Kaplnka Sedembolestnej Panny Márie - Piešť I. u Slobodov">
        <x-page-section.img-media columns="4" type="right" name="" :model="$pageData"/>
        <x-page-section.text type="left">
            <p>
    ...
    <x-page-section title="Kaplnka Sedembolestnej Panny Márie - Sliacka Poľana">
        <x-page-section.img-media columns="4" type="left" name="" :model="$pageData"/>
        <x-page-section.text type="right">
            <p>
    ...
    <x-page-section title="Kaplnka Božieho milosrdenstva - Piešť I. u Svoreňov">
        <x-page-section.img-media columns="4" type="right" name="" :model="$pageData"/>
        <x-page-section.text type="left">
            <p>
    ...
    <x-page-section title="Kaplnka Panny Márie, Matky ustavičnej pomoci - Krné">
        <x-page-section.img-media columns="4" type="left" name="" :model="$pageData"/>
        <x-page-section.text type="right">
            <p>
    ...
    <x-page-section title="Ekumenická kaplnka - Domov dôchodcov Detva">
        <x-page-section.img-media columns="4" type="right" name="" :model="$pageData"/>
        <x-page-section.text type="left">
            <p>
    ...
    <x-page-section title="Meditačná kaplnka - Domov sociálnych služieb Detva, stredisko Piešť">
        <x-page-section.img-media columns="4" type="left" name="" :model="$pageData"/>
        <x-page-section.text type="right">
            <p>
