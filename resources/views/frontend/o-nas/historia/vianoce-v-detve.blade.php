<x-frontend.layout.master :pageData="$pageData">
    ...
    <x-frontend.page.information-sources title="Použitá literatúra:">
        ...
        <li>Vianočná polnočná omša v Detve [online]. [cit. 19.03.2021]. Dostupné na internete: https://www.youtube.com/watch?v=vmkGmjVg6o0</li>
