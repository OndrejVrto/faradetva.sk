...
@section('content')
    ...
    <x-page-section title="Pochovávanie a uchovávanie popola v prípade kremácie">
        <x-page-section.img-media columns="4" type="left" name="" :model="$pageData"/>
        <x-page-section.text type="right">
            <p>
    ...
    <x-page-section title="Ako vybaviť pohreb">
        <x-page-section.img-media columns="4" type="left" name="" :model="$pageData"/>
        <x-page-section.text type="right">
            <p>
    ...
    <x-page-section.sources title="Použitá literatúra:">
        <li>Pohrebné obrady. Trnava: Spolok sv. Vojtecha, 2008. ISBN 978-80-7162-710-4.</li>
        <li>Inštrukcia „Ad resurgendum cum Christo“ ohľadom pochovávania zomrelých a uchovávania popola v prípade kremácie. [online]. [cit. 26.01.2022]. Dostupné na internete: https://www.kbs.sk/obsah/sekcia/h/dokumenty-a-vyhlasenia/p/dokumenty-vatikanskych-uradov/c/instrukcia-ad-resurgendum-cum-christo</li>
