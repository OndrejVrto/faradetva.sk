...
@section('content')
    <x-page-section title="Ako sa uskutočňuje sviatosť manželstva?">
    ...
    <x-page-section title="Čo nevyhnutne patrí ku kresťanskému sviatostnému manželstvu?">
    ...
    <x-page-section title="Prečo je manželstvo nerozlučiteľné?">
        <x-page-section.text type="right">
            <p>
    ...
    <x-page-section title="Sú všetci ľudia povolaní do manželstva?">
        {{-- <x-page-section.img-media columns="5" type="right" name="" :model="$pageData"/> --}}
        <x-page-section.text type="left">
            <p>
    ...
    <x-page-section title="Ako treba postupovať pred uzavretím manželstva?">
        {{-- <x-page-section.img-media columns="4" type="left" name="" :model="$pageData"/> --}}
        <x-page-section.text type="right">
            <p>
    ...
    <x-page-section title="Čo treba robiť, ak sa chce katolík zosobášiť s nekatolíkom alebo s partnerom, ktorý vyznáva iné náboženstvo?">
    ...
    <x-page-section title="Môžu sa manželia žijúci v trvalých nezhodách odlúčiť?">
        {{-- <x-page-section.img-media columns="4" type="left" name="" :model="$pageData"/> --}}
        <x-page-section.text type="right">
            <p>
    ...
    <x-page-section title="Čo ohrozuje manželstvo?">
        {{-- <x-page-section.img-media columns="4" type="right" name="" :model="$pageData"/> --}}
        <x-page-section.text type="left">
            <p>
    ...
    <x-page-section title="Aký je postoj Cirkvi k rozvedeným, ktorí uzavreli nový sobáš?">
        <x-page-section.text type="right">
            <p>
    ...
    <x-page-section title="Prečo sa kresťanská rodina nazýva tiež „domáca Cirkev“?">
        {{-- <x-page-section.img-media columns="4" type="right" name="" :model="$pageData"/> --}}
        <x-page-section.text type="left">
            <p>
    ...
    <x-page-section title="Ako vyzerá blízka príprava k manželstvu v našej farnosti?">
        <x-page-section.text type="right">
            <p>
