...
@section('content')
    <x-page-section title="Čo je birmovanie?">
    ...
    <x-page-section title="Čo hovorí Sväté písmo o sviatosti birmovania?">
    ...
    <x-page-section title="Čo sa deje pri birmovaní?">
        {{-- <x-page-section.img-media columns="4" type="left" name="" :model="$pageData"/> --}}
        <x-page-section.text type="right">
            <p>
    ...
    <x-page-section title="Kto môže prijať birmovanie a čo sa očakáva od uchádzača o birmovanie?">
    ...
    <x-page-section title="Kto môže birmovať?">
        {{-- <x-page-section.img-media columns="4" type="left" name="" :model="$pageData"/> --}}
        <x-page-section.text type="right">
            <p>
    ...
    <x-page-section title="Ako v našej farnosti prebieha príprava k sviatosti birmovania?">
        {{-- <x-page-section.img-media columns="4" type="right" name="" :model="$pageData"/> --}}
        <x-page-section.text type="left">
            <p>
