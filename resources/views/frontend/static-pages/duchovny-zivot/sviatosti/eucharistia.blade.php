...
@section('content')
    <x-page-section title="Čo je Eucharistia?">
    ...
    <x-page-section title="Nakoľko je Eucharistia dôležitá pre Cirkev?">
    ...
    <x-page-section title="Ktoré prvky patria neodmysliteľne k svätej omši?">
        <x-page-section.text type="right">
            <p>
    ...
    <x-page-section title="Kto vedie slávenie Eucharistie?">
        {{-- <x-page-section.img-media columns="5" type="right" name="" :model="$pageData"/> --}}
        <x-page-section.text type="left">
            <p>
    ...
    <x-page-section title="Akým spôsobom je Ježiš prítomný v Eucharistii?">
        {{-- <x-page-section.img-media columns="4" type="left" name="" :model="$pageData"/> --}}
        <x-page-section.text type="right">
            <p>
    ...
    <x-page-section title="	Akým spôsobom sa Cirkev podieľa na Eucharistii?">
    ...
    <x-page-section title="Ako máme správne uctievať Pána Ježiša prítomného v chlebe a vo víne?">
        {{-- <x-page-section.img-media columns="4" type="left" name="" :model="$pageData"/> --}}
        <x-page-section.text type="right">
            <p>
    ...
    <x-page-section title="Ako často sa má kresťan katolík zúčastňovať na svätej omši?">
        {{-- <x-page-section.img-media columns="4" type="right" name="" :model="$pageData"/> --}}
        <x-page-section.text type="left">
            <p>
    ...
    <x-page-section title="Ako sa mám pripraviť, aby som mohol pristúpiť k svätému prijímaniu?">
        <x-page-section.text type="right">
            <p>
    ...
    <x-page-section title="Ako ma mení sväté prijímanie?">
        {{-- <x-page-section.img-media columns="4" type="right" name="" :model="$pageData"/> --}}
        <x-page-section.text type="left">
            <p>
    ...
    <x-page-section title="Môže sa Eucharistia podávať aj nekatolíckym kresťanom?">
        <x-page-section.text type="right">
            <p>
    ...
    <x-page-section title="Kedy môžem po prvýkrát prijať Eucharistiu?">
        {{-- <x-page-section.img-media columns="4" type="right" name="" :model="$pageData"/> --}}
        <x-page-section.text type="left">
            <p>
