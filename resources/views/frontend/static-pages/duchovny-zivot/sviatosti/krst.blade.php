...
@section('content')
    <x-page-section title="Čo je to krst?">
    ...
    <x-page-section title="Ako sa udeľuje krst?">
    ...
    <x-page-section title="Kto môže byť pokrstený a čo sa vyžaduje od čakateľa na krst?">
        {{-- <x-page-section.img-media columns="5" type="right" name="" :model="$pageData"/> --}}
        <x-page-section.text type="left">
            <p>
    ...
    <x-page-section title="Prečo Cirkev krstí malé deti?">
        {{-- <x-page-section.img-media columns="4" type="left" name="" :model="$pageData"/> --}}
        <x-page-section.text type="right">
            <p>
    ...
    <x-page-section title="Kto môže krstiť?">
    ...
    <x-page-section title="Čo sa deje pri krste?">
        {{-- <x-page-section.img-media columns="4" type="left" name="" :model="$pageData"/> --}}
        <x-page-section.text type="right">
            <p>
    ...
    <x-page-section title="Aký význam má meno, ktoré pri krste dostávame?">
        {{-- <x-page-section.img-media columns="4" type="right" name="" :model="$pageData"/> --}}
        <x-page-section.text type="left">
            <p>
    ...
    <x-page-section title="Prečo by sme mali mať krstné meno po nejakom veľkom svätcovi?">
        {{-- <x-page-section.img-media columns="4" type="left" name="" :model="$pageData"/> --}}
        <x-page-section.text type="right">
            <p>
    ...
    <x-page-section title="Ako sa vysluhuje sviatosť krstu v našej farnosti?">
        {{-- <x-page-section.img-media columns="4" type="right" name="" :model="$pageData"/> --}}
        <x-page-section.text type="left">
            <p>
    ...
    <x-page-section title="Kto môže byť krstným rodičom?">
        {{-- <x-page-section.img-media columns="4" type="left" name="" :model="$pageData"/> --}}
        <x-page-section.text type="right">
            <p>
    ...
    <x-page-section title="Podmienky k tomu, aby mohol byť niekto krstným rodičom:">
        {{-- <x-page-section.img-media columns="4" type="right" name="" :model="$pageData"/> --}}
        <x-page-section.text type="left">
            <ul>
    ...
    <x-page-section title="Ako prebieha príprava ku krstu starších detí a dospelých?">
        {{-- <x-page-section.img-media columns="4" type="left" name="" :model="$pageData"/> --}}
        <x-page-section.text type="right">
            <p>
