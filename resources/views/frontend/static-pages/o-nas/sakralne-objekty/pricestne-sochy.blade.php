...
@section('content')
    ...
    <x-page-section title="Sv. Ján Nepomucký">
    ...
    <x-page-section title="Sv. Florián">
        <x-page-section.img-media columns="4" type="left" name="" :model="$pageData"/>
        <x-page-section.text type="right">
            <p>
    ...
    <x-page-section.sources title="Použitá literatúra:">
        ...
        <li>Florián, mučeník [online]. [cit. 18.03.2021]. Dostupné na internete: https://www.zivotopisysvatych.sk/florian/</li>
        <li>Ján Nepomucký, kňaz, mučeník [online]. [cit. 18.03.2021]. Dostupné na internete: https://www.zivotopisysvatych.sk/jan-nepomucky/</li>
