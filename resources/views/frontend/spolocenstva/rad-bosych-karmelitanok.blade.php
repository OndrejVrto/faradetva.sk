...
@section('content')
    ...
    <x-page-section title="Základné body života karmelitánok">
        <x-page-section.img-media columns="4" type="left" name="" :model="$pageData"/>
        <x-page-section.text type="right">
            <ul>
    ...
    <x-page-section title="Modlitba - srdce karmelitánskeho života">
    ...
    <x-page-section title="Samota a mlčanie">
        <x-page-section.img-media columns="4" type="right" name="" :model="$pageData"/>
        <x-page-section.text type="left">
            <p>
    ...
    <x-page-section title="Mariánska úcta - škapuliar">
        <x-page-section.img-media columns="4" type="right" name="" :model="$pageData"/>
        <x-page-section.text type="left">
            <p>
    ...
    <x-page-section title="Bosé karmelitánky vo svete a na Slovensku">
        <x-page-section.img-media columns="4" type="left" name="" :model="$pageData"/>
        <x-page-section.text type="right">
            <p>
