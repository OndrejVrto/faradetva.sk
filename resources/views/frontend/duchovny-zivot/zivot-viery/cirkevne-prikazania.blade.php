<x-frontend.layout.master :pageData="$pageData">
    ...
    <x-frontend.page.section name="PAGE: ({{$pageData['title']}}) -" class="static-page pad_b_50">
        ...
        <x-frontend.page.subsection title="I. V nedeľu a v prikázaný sviatok sa zúčastniť celej svätej omše">
            {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
            <x-frontend.page.text-segment>
                <p>
                ...
                <p>
                    Prikázané sviatky:
                        <ul>
                            <li>Narodenie Pána (25.12.),</li>
                            <li>Zjavenie Pána (6.1.),</li>
                            <li>Nanebovstúpenie Pána (40. deň po Veľkej noci),</li>
                            <li>Najsvätejšie Kristovo telo a krv (štvrtok po Nedeli Najsvätejšej trojice),</li>
                            <li>Bohorodičky Panny Márie (1.1.),</li>
                            <li>Nanebovzatie Panny Márie (15.8.),</li>
                            <li>Nepoškvrnené počatie Panny Márie (8.12.),</li>
                            <li>Svätých apoštolov Petra a Pavla (29.6.),</li>
        ...
        <x-frontend.page.subsection title="II. Zachovávať prikázané dni pokánia" animation="fromleft">
            {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
            <x-frontend.page.text-segment animation="fromleft">
                <p>
                ...
                <p>
                    Všetky piatky v roku sú dňami pokánia. Veriaci majú povinnosť konať niektorý z týchto druhov pokánia:
                        <ol>
                            <li>zdržovať sa mäsitých pokrmov</li>
                            <li>vykonať skutok nábožnosti (svätá omša, bolestný ruženec, krížová cesta)</li>
                            <li>čítanie Svätého písma aspoň 10 minút</li>
                            <li>navštíviť chorého s konkrétnym prejavom pomoci</li>
        ...
        <x-frontend.page.subsection title="III. Aspoň raz v roku sa vyspovedať a vo Veľkonočnom období prijať Oltárnu sviatosť">
            {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
            <x-frontend.page.text-segment>
                <p>
        ...
        <x-frontend.page.subsection title="IV. Uzatvárať manželstvo pred tvárou Cirkvi" animation="fromleft">
            {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
            <x-frontend.page.text-segment animation="fromleft">
                <p>
        ...
        <x-frontend.page.subsection title="V. Podporovať cirkevné ustanovizne">
            {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
            <x-frontend.page.text-segment>
                <p>
