<x-frontend.layout.master :pageData="$pageData">
    ...
    <x-frontend.page.section name="PAGE: ({{$pageData['title']}}) -" class="static-page pad_b_50">
        ...
        <x-frontend.page.subsection title="I. Ja som Pán, tvoj Boh: Nebudeš mať okrem mňa iných bohov, ktorým by si sa klaňal">
            {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
        ...
        <x-frontend.page.subsection title="II. Nevezmeš Božie meno nadarmo" animation="fromleft">
            {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
            <x-frontend.page.text-segment animation="fromleft">
                <p>
        ...
        <x-frontend.page.subsection title="III. Pamätaj, že máš svätiť sviatočné dni">
            {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
            <x-frontend.page.text-segment>
                <p>
        ...
        <x-frontend.page.subsection title="IV. Cti svojho otca a svoju matku" animation="fromleft">
            {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
            <x-frontend.page.text-segment animation="fromleft">
                <p>
        ...
        <x-frontend.page.subsection title="V. Nezabiješ">
            {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
            <x-frontend.page.text-segment>
                <p>
        ...
        <x-frontend.page.subsection title="VI. Nezosmilníš" animation="fromleft">
            {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
            <x-frontend.page.text-segment animation="fromleft">
                <p>
        ...
        <x-frontend.page.subsection title="VII. Nepokradneš">
            {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
            <x-frontend.page.text-segment>
                <p>
        ...
        <x-frontend.page.subsection title="VIII. Nebudeš krivo svedčiť proti svojmu blížnemu" animation="fromleft">
            {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
            <x-frontend.page.text-segment animation="fromleft">
                <p>
        ...
        <x-frontend.page.subsection title="IX. Nebudeš žiadostivo túžiť po manželke svojho blížneho">
            {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
            <x-frontend.page.text-segment>
                <p>
        ...
        <x-frontend.page.subsection title="X. Nebudeš túžiť po majetku svojho blížneho" animation="fromleft">
            {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
            <x-frontend.page.text-segment animation="fromleft">
                <p>
