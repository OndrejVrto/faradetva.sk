<x-frontend.layout.master :pageData="$pageData">
    ...
    <x-frontend.page.section name="PAGE: ({{$pageData['title']}}) -" class="static-page pad_b_50">
        ...
        <x-frontend.page.subsection title="Liturgický rok a ľudová zbožnosť">
            {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
            <x-frontend.page.text-segment>
                <p>
        ...
        <x-frontend.page.subsection title="Uctievanie svätej Matky Pána Ježiša" animation="fromleft">
            {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
            <x-frontend.page.text-segment animation="fromleft">
                <p>
        ...
        <x-frontend.page.subsection title="Uctievanie svätých a blahoslavených">
            {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
            <x-frontend.page.text-segment>
                <p>
        ...
        <x-frontend.page.information-sources title="Použitá literatúra:">
            <li>OSTRIHOŇOVÁ, Anna. Kalendárne obyčaje a obyčaje životného cyklu. In: Anna Ostrihoňová. ed. Detva. Monografia mesta. Detva: Mesto Detva, 2018. ISBN 978-80-9730011-2-5.</li>
            <li>Direktórium o ľudovej zbožnosti a liturgii. Trnava: Spolok sv. Vojtecha, 2005. ISBN 80-7162-547-7.</li>
