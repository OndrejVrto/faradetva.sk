<x-frontend.layout.master :pageData="$pageData">
    ...
    <x-frontend.page.subsection title="Komu je určená sviatosť chorých?">
    ...
    <x-frontend.page.subsection title="Ako sa slávi sviatosť pomazania chorých?">
        <x-frontend.page.text-segment animation="fromright">
            <p>
    ...
    <x-frontend.page.subsection title="Aké účinky má sviatosť chorých?">
        {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="5" /> --}}
        <x-frontend.page.text-segment animation="fromleft">
            <p>
    ...
    <x-frontend.page.subsection title="Čo je to viatikum?">
        {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4"/> --}}
        <x-frontend.page.text-segment animation="fromright">
            <p>
    ...
    <x-frontend.page.subsection title="Čo znamená byť zaopatrený sviatosťami a ako je k tomu možné prísť?">
        {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
        <x-frontend.page.text-segment animation="fromleft">
            <p>
