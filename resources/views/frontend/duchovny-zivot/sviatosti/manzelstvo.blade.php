<x-frontend.layout.master :pageData="$pageData">
    ...
    <x-frontend.page.subsection title="Ako sa uskutočňuje sviatosť manželstva?">
    ...
    <x-frontend.page.subsection title="Čo nevyhnutne patrí ku kresťanskému sviatostnému manželstvu?">
    ...
    <x-frontend.page.subsection title="Sú všetci ľudia povolaní do manželstva?">
        {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="5" /> --}}
        <x-frontend.page.text-segment animation="fromleft">
            <p>
    ...
    <x-frontend.page.subsection title="Ako treba postupovať pred uzavretím manželstva?">
        {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4"/> --}}
        <x-frontend.page.text-segment animation="fromright">
            <p>
    ...
    <x-frontend.page.subsection title="Čo treba robiť, ak sa chce katolík zosobášiť s nekatolíkom alebo s partnerom, ktorý vyznáva iné náboženstvo?">
        {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
        <x-frontend.page.text-segment animation="fromleft">
            <p>
    ...
    <x-frontend.page.subsection title="Môžu sa manželia žijúci v trvalých nezhodách odlúčiť?">
        {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4"/> --}}
        <x-frontend.page.text-segment animation="fromright">
            <p>
    ...
    <x-frontend.page.subsection title="Čo ohrozuje manželstvo?">
        {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
        <x-frontend.page.text-segment animation="fromleft">
            <p>
    ...
    <x-frontend.page.subsection title="Aký je postoj Cirkvi k rozvedeným, ktorí uzavreli nový sobáš?">
        <x-frontend.page.text-segment animation="fromright">
            <p>
    ...
    <x-frontend.page.subsection title="Prečo sa kresťanská rodina nazýva tiež „domáca Cirkev“?">
        {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
        <x-frontend.page.text-segment animation="fromleft">
            <p>
    ...
    <x-frontend.page.subsection title="Ako vyzerá blízka príprava k manželstvu v našej farnosti?">
        <x-frontend.page.text-segment animation="fromright">
            <p>
