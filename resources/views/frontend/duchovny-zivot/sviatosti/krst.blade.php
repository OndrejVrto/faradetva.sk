<x-frontend.layout.master :pageData="$pageData">
    ...
    <x-frontend.page.subsection title="Čo je to krst?">
    ...
    <x-frontend.page.subsection title="Ako sa udeľuje krst?">
    ...
    <x-frontend.page.subsection title="Kto môže byť pokrstený a čo sa vyžaduje od čakateľa na krst?">
        {{-- <x-partials.picture titleSlug="blank" arrival="right" dimensionSource="full" columns="5" /> --}}
        <x-frontend.page.text-segment type="left">
            <p>
    ...
    <x-frontend.page.subsection title="Prečo Cirkev krstí malé deti?">
        {{-- <x-partials.picture titleSlug="blank" arrival="right" dimensionSource="full" columns="4"/> --}}
        <x-frontend.page.text-segment type="right">
            <p>
    ...
    <x-frontend.page.subsection title="Kto môže krstiť?">
        {{-- <x-partials.picture titleSlug="blank" arrival="right" dimensionSource="full" columns="4" /> --}}
        <x-frontend.page.text-segment type="left">
            <p>
    ...
    <x-frontend.page.subsection title="Čo sa deje pri krste?">
        {{-- <x-partials.picture titleSlug="blank" arrival="right" dimensionSource="full" columns="4"/> --}}
        <x-frontend.page.text-segment type="right">
            <p>
    ...
    <x-frontend.page.subsection title="Aký význam má meno, ktoré pri krste dostávame?">
        {{-- <x-partials.picture titleSlug="blank" arrival="right" dimensionSource="full" columns="4" /> --}}
        <x-frontend.page.text-segment type="left">
            <p>
    ...
    <x-frontend.page.subsection title="Prečo by sme mali mať krstné meno po nejakom veľkom svätcovi?">
        {{-- <x-partials.picture titleSlug="blank" arrival="right" dimensionSource="full" columns="4"/> --}}
        <x-frontend.page.text-segment type="right">
            <p>
    ...
    <x-frontend.page.subsection title="Ako sa vysluhuje sviatosť krstu v našej farnosti?">
        {{-- <x-partials.picture titleSlug="blank" arrival="right" dimensionSource="full" columns="4" /> --}}
        <x-frontend.page.text-segment type="left">
            <p>
    ...
    <x-frontend.page.subsection title="Kto môže byť krstným rodičom?">
        {{-- <x-partials.picture titleSlug="blank" arrival="right" dimensionSource="full" columns="4"/> --}}
        <x-frontend.page.text-segment type="right">
            <p>
    ...
    <x-frontend.page.subsection title="Podmienky k tomu, aby mohol byť niekto krstným rodičom:">
        {{-- <x-partials.picture titleSlug="blank" arrival="right" dimensionSource="full" columns="4" /> --}}
        <x-frontend.page.text-segment type="left">
            <ul>
                <li>Musí byť na to schopný a mať úmysel plniť túto úlohu.</li>
                <li>Mať zavŕšený 16-ty rok života.</li>
                <li>Musí byť katolík, pobirmovaný, prijal už najsvätejšiu Eucharistiu a vedie život primeraný viere a úlohe, ktorú má prijať.</li>
                <li>Nesmie mu byť uložený žiadny cirkevný trest.</li>
                <li>Musí byť sobášený v Katolíckej cirkvi. Ak je slobodný, nemôže žiť vo voľnom partnerskom zväzku, napr. ako „druh a družka“. Ak je rozvedený a nežije v ďalšom zväzku, musí mať od svojho biskupa povolenie pristupovať k sviatostiam.</li>
                <li>emôže byť rodičom krstenca.</li>
                <li>Nekatolík môže byť jedine spolu s katolíckym krstným rodičom, a to iba ako svedok krstu.</li>
            </ul>
        </x-frontend.page.text-segment>
    </x-frontend.page.subsection>

    <x-frontend.page.subsection title="Ako prebieha príprava ku krstu starších detí a dospelých?">
        {{-- <x-partials.picture titleSlug="blank" arrival="right" dimensionSource="full" columns="4"/> --}}
        <x-frontend.page.text-segment type="right">
            <p>
    ...
    <x-frontend.page.information-sources title="Použitá literatúra:">
        ...
        <li>Youcat po slovensky. <em>Katechizmus Katolíckej cirkvi pre mladých.</em> Bratislava: Karmelitánske nakladateľstvo, 2011. ISBN 978-80-89231-99-7.</li>
