...
@section('content')
    <x-page-section title="Ako inak nazývame sviatosť zmierenia a prečo potrebujeme túto sviatosť?">
    ...
    <x-page-section title="Kto môže odpúšťať hriechy?">
    ...
    <x-page-section title="Ako sa možno pripraviť na ľútosť nad hriechmi?">
        <x-page-section.text type="right">
            <p>
    ...
    <x-page-section title="V čom spočíva príprava na sviatosť zmierenia?">
        {{-- <x-page-section.img-media columns="5" type="right" name="" :model="$pageData"/> --}}
        <x-page-section.text type="left">
            <p>
    ...
    <x-page-section title="Čo je to pokánie?">
        {{-- <x-page-section.img-media columns="4" type="left" name="" :model="$pageData"/> --}}
        <x-page-section.text type="right">
            <p>
    ...
    <x-page-section title="Z akých hriechov sa mám vlastne spovedať?">
    ...
    <x-page-section title="Kedy je človek povinný vyspovedať sa zo svojich smrteľných hriechov? Ako často by mal pristupovať k sviatosti zmierenia?">
        {{-- <x-page-section.img-media columns="4" type="left" name="" :model="$pageData"/> --}}
        <x-page-section.text type="right">
            <p>
    ...
    <x-page-section title="Môže človek pristúpiť k sviatosti zmierenia aj keď sa nedopustil žiadnych smrteľných hriechov?">
        {{-- <x-page-section.img-media columns="4" type="right" name="" :model="$pageData"/> --}}
        <x-page-section.text type="left">
            <p>
    ...
    <x-page-section title="Existujú také závažné hriechy, ktoré by kňaz nemohol rozhrešiť?">
        <x-page-section.text type="right">
            <p>
    ...
    <x-page-section title="Môže kňaz prezradiť niečo z toho, čo sa dozvedel vo sviatosti zmierenia?">
        {{-- <x-page-section.img-media columns="4" type="right" name="" :model="$pageData"/> --}}
        <x-page-section.text type="left">
            <p>
    ...
    <x-page-section title="Aký pozitívny účinok prináša sviatosť zmierenia?">
        <x-page-section.text type="right">
            <p>
    ...
    <x-page-section title="Kedy sa môžem vyspovedať vo farnosti Detva?">
        <x-page-section.text type="right">
            <p>
