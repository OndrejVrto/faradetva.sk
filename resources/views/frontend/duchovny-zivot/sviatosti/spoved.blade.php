<x-frontend.layout.master :pageData="$pageData">
    ...
    <x-frontend.page.subsection title="Ako inak nazývame sviatosť zmierenia a prečo potrebujeme túto sviatosť?">
    ...
    <x-frontend.page.subsection title="Kto môže odpúšťať hriechy?">
    ...
    <x-frontend.page.subsection title="Ako sa možno pripraviť na ľútosť nad hriechmi?">
        <x-frontend.page.text-segment type="right">
            <p>
    ...
    <x-frontend.page.subsection title="V čom spočíva príprava na sviatosť zmierenia?">
        {{-- <x-partials.picture titleSlug="blank" arrival="right" dimensionSource="full" columns="5" /> --}}
        <x-frontend.page.text-segment type="left">
            <p>
    ...
    <x-frontend.page.subsection title="Čo je to pokánie?">
        {{-- <x-partials.picture titleSlug="blank" arrival="right" dimensionSource="full" columns="4"/> --}}
        <x-frontend.page.text-segment type="right">
            <p>
    ...
    <x-frontend.page.subsection title="Z akých hriechov sa mám vlastne spovedať?">
        {{-- <x-partials.picture titleSlug="blank" arrival="right" dimensionSource="full" columns="4" /> --}}
        <x-frontend.page.text-segment type="left">
            <p>
    ...
    <x-frontend.page.subsection title="Kedy je človek povinný vyspovedať sa zo svojich smrteľných hriechov? Ako často by mal pristupovať k sviatosti zmierenia?">
        {{-- <x-partials.picture titleSlug="blank" arrival="right" dimensionSource="full" columns="4"/> --}}
        <x-frontend.page.text-segment type="right">
            <p>
    ...
    <x-frontend.page.subsection title="Môže človek pristúpiť k sviatosti zmierenia aj keď sa nedopustil žiadnych smrteľných hriechov?">
        {{-- <x-partials.picture titleSlug="blank" arrival="right" dimensionSource="full" columns="4" /> --}}
        <x-frontend.page.text-segment type="left">
            <p>
    ...
    <x-frontend.page.subsection title="Existujú také závažné hriechy, ktoré by kňaz nemohol rozhrešiť?">
        <x-frontend.page.text-segment type="right">
            <p>
    ...
    <x-frontend.page.subsection title="Môže kňaz prezradiť niečo z toho, čo sa dozvedel vo sviatosti zmierenia?">
        {{-- <x-partials.picture titleSlug="blank" arrival="right" dimensionSource="full" columns="4" /> --}}
        <x-frontend.page.text-segment type="left">
            <p>
    ...
    <x-frontend.page.subsection title="Aký pozitívny účinok prináša sviatosť zmierenia?">
        <x-frontend.page.text-segment type="right">
            <p>
    ...
    <x-frontend.page.subsection title="Kedy sa môžem vyspovedať vo farnosti Detva?">
        <x-frontend.page.text-segment type="right">
            <p>
