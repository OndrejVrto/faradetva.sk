<x-frontend.layout.master :pageData="$pageData">
    ...
    <x-frontend.page.subsection title="Čo je sviatosť posvätného stavu?">
    ...
    <x-frontend.page.subsection title="Aké miesto má sviatosť posvätného stavu v Božom pláne spásy?">
    ...
    <x-frontend.page.subsection title="Kto môže prijať sviatosť posvätného stavu?">
        <x-frontend.page.text-segment animation="fromright">
            <p>
    ...
    <x-frontend.page.subsection title="Aký účinok má diakonská vysviacka?">
        {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="5" /> --}}
        <x-frontend.page.text-segment animation="fromleft">
            <p>
    ...
    <x-frontend.page.subsection title="Aký účinok má kňazská vysviacka?">
        {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4"/> --}}
        <x-frontend.page.text-segment animation="fromright">
            <p>
    ...
    <x-frontend.page.subsection title="Aký účinok má biskupská vysviacka?">
        {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
        <x-frontend.page.text-segment animation="fromleft">
            <p>
    ...
    <x-frontend.page.subsection title="Ako sa odlišuje všeobecné kňazstvo všetkých veriacich od sviatostného kňazstva?">
        {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4"/> --}}
        <x-frontend.page.text-segment animation="fromright">
            <p>
    ...
    <x-frontend.page.subsection title="Ako sa niekto môže stať kňazom?">
        {{-- <x-partials.picture titleSlug="blank" animation="fromright" dimensionSource="full" columns="4" /> --}}
        <x-frontend.page.text-segment animation="fromleft">
            <p>
