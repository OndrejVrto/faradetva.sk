...
@section('content')
    ...
    <x-page-section >
        <x-page-section.img columns="4" type="left" alt="" url="{{ asset('images/only-for-debug/sv-francisco/images.jpg') }}" />
    ...
    <x-page-section title="Posledné roky života">
        <x-page-section.img columns="4" type="left" alt="" url="{{ asset('images/only-for-debug/sv-francisco/1627905656-porciunkula (1).jpg') }}" />
        <x-page-section.text type="right">
            <p>
    ...
    <x-page-section title="Dianie po smrti">
        <x-page-section.img columns="4" type="right" alt="" url="{{ asset('images/only-for-debug/sv-francisco/francis_and_first_followers_690.jpg') }}" />
        <x-page-section.text type="left">
            <p>
        ...
        <x-page-section.img columns="4" type="left" alt="" url="{{ asset('images/only-for-debug/sv-francisco/WEB3-SAINT-FRANCIS-OF-ASSISI-SHEPHERD-SHEEP-WOLF-shutterstock_710430052.jpg')  }}" />
        <x-page-section.text type="right">
            <p>
