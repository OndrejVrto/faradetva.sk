...
@section('content')
    ...
    <x-page-section >
        <x-page-section.img columns="4" type="left" alt="" url="{{ URL::asset('images/only-for-debug/sv-francisco/images.jpg') }}" />
    ...
    <x-page-section title="Mladosť">
        <x-page-section.img columns="5" type="right" alt="" url="{{ URL::asset('images/only-for-debug/sv-francisco/602199.jpg') }}" />
        ...
        <x-page-section.img columns="4" type="left" alt="" url="{{ URL::asset('images/only-for-debug/sv-francisco/Josep_Benlliure_Gil43.jpg')  }}" />
        <x-page-section.text type="right">
            <p>
    ...
    <x-page-section title="Povolanie">
        <x-page-section.img columns="4" type="right" alt="" url="{{ URL::asset('images/only-for-debug/sv-francisco/Saint_Francis_of_Assisi_by_Jusepe_de_Ribera.jpg') }}" />
        <x-page-section.text type="left">
            <p>
    ...
    <x-page-section title="Františkánske spoločenstvo">
        <x-page-section.img columns="4" type="left" alt="aaa" url="{{ URL::asset('images/only-for-debug/sv-francisco/StFrancis_part.jpg') }}" />
        <x-page-section.text type="right">
            <p>
    ...
    <x-page-section title="Apoštolát">
        <x-page-section.img columns="4" type="right" alt="" url="{{ URL::asset('images/only-for-debug/sv-francisco/st_francis_of_assisi_receiving_the_stigmata-12701.jpg') }}" />
        <x-page-section.text type="left">
            <p>
    ...
    <x-page-section title="Posledné roky života">
        <x-page-section.img columns="4" type="left" alt="" url="{{ URL::asset('images/only-for-debug/sv-francisco/1627905656-porciunkula (1).jpg') }}" />
        <x-page-section.text type="right">
            <p>
    ...
    <x-page-section title="Dianie po smrti">
        <x-page-section.img columns="4" type="right" alt="" url="{{ URL::asset('images/only-for-debug/sv-francisco/francis_and_first_followers_690.jpg') }}" />
        <x-page-section.text type="left">
            <p>
        ...
        <x-page-section.img columns="4" type="left" alt="" url="{{ URL::asset('images/only-for-debug/sv-francisco/WEB3-SAINT-FRANCIS-OF-ASSISI-SHEPHERD-SHEEP-WOLF-shutterstock_710430052.jpg')  }}" />
        <x-page-section.text type="right">
            <p>
