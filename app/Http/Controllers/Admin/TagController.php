...
class TagController extends Controller {
    ...
    public function store(TagRequest $request): RedirectResponse {
        ...
        toastr()->success((string) __('app.tag.store'));
    ...
    public function update(TagRequest $request, Tag $tag): RedirectResponse {
        ...
        toastr()->success((string) __('app.tag.update'));
        return to_route('tags.index');
    }
    ...
    public function destroy(Tag $tag): RedirectResponse {
        ...
        toastr()->success((string) __('app.tag.delete'));
        return to_route('tags.index');
    }
    ...
    public function restore(int $id): RedirectResponse {
        ...
        toastr()->success((string) __('app.tag.restore'));
    ...
    public function force_delete(int $id): RedirectResponse {
        ...
        toastr()->success((string) __('app.tag.force-delete'));
